		...
		<xsl:if test="position()=last()">
			<row>
				<column>
					<name>CHAN_ID</name>
					<value>
						<xsl:value-of select="document(concat($uripath,'UP_SEQUENCE_20.XML'))
						/data/table/rows/row[column[name='SEQUENCE_NAME' and value='UP_CHANNEL']]/column[name='SEQUENCE_VALUE']/value+1"/>
					</value>
				</column>
				<column>
			...
			<row>
				<column>
					...
					<value>
						<xsl:value-of select="document(concat($uripath,'UP_SEQUENCE_20.XML'))
						/data/table/rows/row[column[name='SEQUENCE_NAME' and value='UP_CHANNEL']]/column[name='SEQUENCE_VALUE']/value+2"/>
					</value>
				</column>
				<column>
					<name>CHAN_TITLE</name>
			...
			<row>
				<column>
					...
					<value>
						<xsl:value-of select="document(concat($uripath,'UP_SEQUENCE_20.XML'))
						/data/table/rows/row[column[name='SEQUENCE_NAME' and value='UP_CHANNEL']]/column[name='SEQUENCE_VALUE']/value+3"/>
					</value>
				</column>
				<column>
					<name>CHAN_TITLE</name>
