...
<xsl:template match="/">
  <table border="0" cellspacing="0" cellpadding="5" align="center">
    <tr><td>Choose a folder to place subscribed channels and click Subscribe.</td></tr>
    <tr><td align="center">
      <table><tr><td>
        <form action="{$baseActionURL}" method="post">
      	  <input type="hidden" name="action" value="subscribeTo"/>
      	  <p align="center"><input type="submit" name="subscribe" value="Subscribe"/></p>
...
<xsl:template match="folder[not(@type = 'header' or @type = 'footer') and @hidden='false']">
