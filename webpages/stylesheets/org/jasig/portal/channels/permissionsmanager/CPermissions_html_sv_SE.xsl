...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <xsl:template name="selectDeselectAll">
          ...
          <tr>
            <td colspan="2">
              <input class="uportal-button" type="button" onClick="javascript:change(this.form,true);" value="Markera alla"/>
              <xsl:text> </xsl:text>
              <input class="uportal-button" type="button" onClick="javascript:change(this.form,false);" value="Avmarkera All"/>
            </td>
          </tr>
        </xsl:template>
          ...
          <input type="hidden" name="prmCommand" value="AssignPermissions"/>
            <xsl:for-each select="//principal">
                ...
                <tr><td colspan="2">
                    ...
                    <br/>
                    <em>
                    	<xsl:text> Tilldela rättigheter för dessa Ägare till denna användare/grupp:</xsl:text>
                    </em>
                    </span>
                </td></tr>
            ...
            <xsl:for-each select="//owner[@selected='true']">
                ...
                <xsl:variable name="activities" select="activity[@selected='true']"/>
                 <tr><td colspan="2">
                    ...
                    <br/>
                    <em>
                    	<xsl:text> Tilldela rättighet till denna ägare för valda mål: </xsl:text>
                    </em>
                    </span>
                </td></tr>
                <tr><td><xsl:text> </xsl:text></td><td>
                ...
                <xsl:for-each select="target[@selected='true']">
                    <xsl:variable name="targetkey" select="@token"/>
                            ...
                            <td class="uportal-background-light">
                            	<span class="uportal-channel-strong">
                            	<xsl:text>Användare/Grupp:</xsl:text>
                            	</span>
                            </td>
                            	<td class="uportal-background-dark">
                                <xsl:attribute name="colspan">
        ...
        <xsl:template name="selectfooter">
            ...
            <tr><td colspan="2">
                <input type="hidden" name="uP_root" value="me"/>
                <input type="submit" value="Skicka" class="uportal-button"/>
                <xsl:text> </xsl:text>
                <input type="reset" value="Återställ" class="uportal-button"/>
            </td></tr>
        </xsl:template>
