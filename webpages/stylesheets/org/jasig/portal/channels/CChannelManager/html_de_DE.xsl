          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="2" class="uportal-channel-text">
            ...
            <tr class="uportal-channel-text" valign="top">
              ...
              <td width="100%" class="uportal-channel-text">
                <a href="{$baseActionURL}?uPCM_action=selectChannelType&amp;locale={$locale}">Veröffentlichung eines neuen Channels</a>
              </td>
            </tr>
            <tr valign="top">
              <td>
              ...
              <td class="uportal-channel-text" width="100%">
                <a href="{$baseActionURL}?uPCM_action=selectModifyChannel&amp;locale={$locale}">Ändern eines veröffentlichten Channel</a>
              </td>
            </tr>
          </table>
        </td>
        ...
        <td>
          <table width="100%" border="0" cellspacing="0" cellpadding="2" class="uportal-channel-text">
            ...
            <tr valign="top">
              ...
              <td class="uportal-channel-text" width="100%">
                <a href="{$baseActionURL}?uPCM_action=cancel&amp;locale={$locale}">Abbrechen und Zurück</a>
              </td>
            </tr>
          </table>
        </td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" class="uportal-background-light">
            ...
            <xsl:choose>
              <xsl:when test="(//*[@ID = $filterByID]//channel)">
                <tr class="uportal-channel-table-header">
                  ...
                  <td nowrap="nowrap" valign="top">Name des Channel</td>
                  <td valign="top">
                    <img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="8"/>
                  </td>
      ...
      <tr class="uportal-channel-text">
        <form name="formRecordsDisplayed" method="post" action="{$baseActionURL}?locale={$locale}">
          ...
          <td width="100%" class="uportal-background-med" valign="top">Anzeige<input type="text" name="recordsPerPage" size="2" class="uportal-input-text"><xsl:attribute name="value"><xsl:value-of select="$recsPerPage"/></xsl:attribute></input>Aufzeichnungen zu einer Zeit.<img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16"/><input type="submit" name="buttonRecordsDisplayed" value="Gehe" class="uportal-button"/></td>
        </form>
      </tr>
    </table>
  </xsl:template>
                  ...
                  <xsl:choose>
                    <xsl:when test="params/step[ID=$stepID]/channel/parameter[substring(@name,1,$prefixLength)=$prefix]">
                      <xsl:for-each select="params/step[ID=$stepID]/channel/parameter[substring(@name,1,$prefixLength)=$prefix]">
                        <tr class="uportal-channel-text" valign="top">
                          <td nowrap="nowrap" align="center">
                            <a href="{$baseActionURL}?uPCM_action=customSettings&amp;uPCM_capture=customSettings&amp;uPCM_subAction=deleteParameter&amp;name={@name}&amp;uPCM_step={$stepID}&amp;locale={$locale}"><img src="{$mediaPath}/remove.gif" width="16" height="16" border="0" alt="Diese Parameter löschen"/></a>
                          </td>
                          <td nowrap="nowrap">
                            <img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="1" height="1" />
                          </td>
  ...
  <xsl:template name="reviewChannel">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="10" class="uportal-background-light">
        ...
        <td>
          <table width="100%" border="0" cellspacing="0" cellpadding="2" class="uportal-background-content">
           ...
           <tr class="uportal-channel-text">
             ...
             <td nowrap="nowrap"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
             <td nowrap="nowrap" valign="top"><strong><a href="{$baseActionURL}?uPCM_action=selectChannelType&amp;uPCM_capture=reviewChannel&amp;locale={$locale}">Typ des Channels:</a></strong></td>
             <td><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
           ...
           <tr class="uportal-channel-text">
             <td nowrap="nowrap" align="center"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="1" height="1" /> </td>
             <td nowrap="nowrap"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
             <td nowrap="nowrap" valign="top"><strong><a href="{$baseActionURL}?uPCM_action=selectGeneralSettings&amp;uPCM_capture=reviewChannel&amp;locale={$locale}">Titel des Kanals:</a></strong></td>
             <td><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
           ...
           <tr class="uportal-channel-text">
             <td nowrap="nowrap" align="center"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="1" height="1" /> </td>
             <td nowrap="nowrap"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
             <td nowrap="nowrap" valign="top"><strong><a href="{$baseActionURL}?uPCM_action=selectGeneralSettings&amp;uPCM_capture=reviewChannel&amp;locale={$locale}">Name des Channels:</a></strong></td>
             <td><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
           ...
           <tr class="uportal-channel-text">
             <td nowrap="nowrap" align="center"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="1" height="1" /> </td>
             <td nowrap="nowrap"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
             <td nowrap="nowrap" valign="top"><strong><a href="{$baseActionURL}?uPCM_action=selectGeneralSettings&amp;uPCM_capture=reviewChannel&amp;locale={$locale}">Channel Funktionsname:</a></strong></td>
             <td><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
           ...
           <tr class="uportal-channel-text">
             <td nowrap="nowrap" align="center"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="1" height="1" /> </td>
             <td nowrap="nowrap"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
             <td nowrap="nowrap" valign="top"><strong><a href="{$baseActionURL}?uPCM_action=selectGeneralSettings&amp;uPCM_capture=reviewChannel&amp;locale={$locale}">Beschreibung des Channels:</a></strong></td>
             <td><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
           ...
           <tr class="uportal-channel-text">
             <td nowrap="nowrap" align="center"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="1" height="1" /> </td>
             <td nowrap="nowrap"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
             <td nowrap="nowrap" valign="top"><strong><a href="{$baseActionURL}?uPCM_action=selectGeneralSettings&amp;uPCM_capture=reviewChannel&amp;locale={$locale}">Channel Abschalten:</a></strong></td>
             <td><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
          ...
          <tr class="uportal-channel-text">
            <td nowrap="nowrap" align="center"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="1" height="1" /> </td>
            <td nowrap="nowrap"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
            <td nowrap="nowrap" valign="top"><strong><a href="{$baseActionURL}?uPCM_action=selectGeneralSettings&amp;uPCM_capture=reviewChannel&amp;locale={$locale}">Klasse des Channels:</a></strong></td>
            <td><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
      ...
      <tr class="uportal-channel-text">
        ...
        <td nowrap="nowrap" valign="top"><strong><a href="{$baseActionURL}?uPCM_action=selectControls&amp;uPCM_capture=reviewChannel&amp;locale={$locale}">Kontrolle des Channels</a></strong></td>
      ...
      <tr class="uportal-channel-text">
        ...
        <td nowrap="nowrap" valign="top"><strong><a href="{$baseActionURL}?uPCM_action=selectCategories&amp;uPCM_capture=reviewChannel&amp;locale={$locale}">Ausgewählte Kategorien:</a></strong></td>
      ...
      <tr class="uportal-channel-text">
        <td nowrap="nowrap" align="center"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="1" height="1" /></td>
        <td nowrap="nowrap"><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
        <td nowrap="nowrap" valign="top"><strong><a href="{$baseActionURL}?uPCM_action=selectGroups&amp;uPCM_capture=reviewChannel&amp;locale={$locale}">Ausgewählte Gruppen und/oder Leute:</a></strong></td>
        <td><img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="16" height="16" /></td>
        <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="manageChannels/customSettings/params/step/channel/parameter">
                      <xsl:for-each select="manageChannels/customSettings/params/step/channel/parameter">
                        <tr class="uportal-channel-text" valign="top">
                          <td nowrap="nowrap" align="center">
                            <a href="{$baseActionURL}?uPCM_action=customSettings&amp;uPCM_capture=customSettings&amp;uPCM_subAction=deleteParameter&amp;name={@name}&amp;locale={$locale}"><img src="{$mediaPath}/remove.gif" width="16" height="16" border="0" alt="Diese Parameter löschen"/></a>
                          </td>
                          <td nowrap="nowrap">
                            <img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="1" height="1" />
                          </td>
                  ...
                  <xsl:choose>         
                    <xsl:when test="/manageChannels/channelDef/params/step/channel/parameter[substring(@name,1,$prefixLength)=$prefix]">
                      <xsl:for-each select="/manageChannels/channelDef/params/step/channel/parameter[substring(@name,1,$prefixLength)=$prefix]">
                        <tr class="uportal-channel-text" valign="top">
                          <td nowrap="nowrap" align="center">
                            <a href="{$baseActionURL}?uPCM_action=channelDef&amp;uPCM_capture=customSettings&amp;uPCM_subAction=deleteParameter&amp;name={@name}&amp;locale={$locale}"><img src="{$mediaPath}/remove.gif" width="16" height="16" border="0" alt="Diese Parameter löschen"/></a>
                          </td>
                          <td nowrap="nowrap">
                            <img alt="Bildschnittstelle" src="{$mediaPath}/transparent.gif" width="1" height="1" />
                          </td>
