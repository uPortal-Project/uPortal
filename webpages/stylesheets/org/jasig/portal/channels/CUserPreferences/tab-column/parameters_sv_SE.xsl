    ...
    <form name="parameters" method="post" action="{$baseActionURL}">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="10" class="uportal-background-light">
        <tr class="uportal-channel-text">
          <td>
            <strong>Kanalinställningar:</strong> Du kan anpassa kanalens inställningar</td>
        </tr>
        <tr>
          <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="not(/userPrefParams/channelDef)">
                      <tr class="uportal-channel-table-header" valign="bottom">
                        <td width="100%">Anpassade kanalinställningar</td>
                      </tr>
                    ...
                    <xsl:otherwise>
                      ...
                      <tr class="uportal-channel-table-header" valign="bottom">
                        <td align="center" nowrap="nowrap">
                          <img alt="utfyllnadsbild" src="{$mediaPath}/transparent.gif" width="16" height="8"/>Help<img alt="utfyllnadsbild" src="{$mediaPath}/transparent.gif" width="16" height="8"/></td>


                        <td width="100%">Kanalinställningar</td>
                      </tr>
                      <tr class="uportal-channel-table-header">
        ...
        <tr>
          <td>
            <input type="submit" name="uPTCUP_submit" value="Tillbaka" onclick="document.parameters.uPTCUP_action.value='back'" class="uportal-button"/>
            <input type="submit" name="uPTCUP_submit" value="Klar" onclick="document.parameters.uPTCUP_action.value='finished'" class="uportal-button"/>
            <input type="submit" name="uPTCUP_submit" value="Avbryt" onclick="document.parameters.uPTCUP_action.value='cancel'" class="uportal-button"/>
          </td>
        </tr>
      </table>
    </form>
