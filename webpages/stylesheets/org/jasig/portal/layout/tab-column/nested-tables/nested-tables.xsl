                    ...
                    <tr>
                      <td align="right">
                        <a href="http://www.ja-sig.org">
                          <img src="{$mediaPath}/{$skin}/powered_by_logo.gif" border="0"/>
                        </a>
                      </td>
                    </tr>
                  </table>
  ...
  <xsl:template match="header">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr class="uportal-background-med">
        <td nowrap="nowrap">
          <a href="http://www.ja-sig.org">
            <img alt="interface image" src="{$mediaPath}/{$skin}/uportal_logo_small.gif" border="0"/>
          </a>
        </td>
        <td nowrap="nowrap" align="right" width="100%" class="uportal-channel-text">
          <xsl:copy-of select="channel[@name='Header']"/>
          <img alt="interface image" src="{$mediaPath}/transparent.gif" width="10" height="1"/>
        </td>
      </tr>
    </table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="1" rowspan="1">
          <img alt="interface image" src="{$mediaPath}/{$skin}/uportal_logo_grid.gif" width="600" height="50"/>
        </td>
      </tr>
      <tr>
        <td colspan="1" rowspan="1">
