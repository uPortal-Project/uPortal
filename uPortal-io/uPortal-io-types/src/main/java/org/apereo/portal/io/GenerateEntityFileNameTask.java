...
/**
 * Cernunnos <code>Task</code> that inspects a finished XML entity document and generates an
...
public class GenerateEntityFileNameTask implements Task {
    ...
    public static final Reagent ENTITY_ELEMENT =
            new SimpleReagent(
                    "ENTITY_ELEMENT",
                    "@entity-element",
                    ReagentType.PHRASE,
    ...
    public static final Reagent LAYOUT_STORE =
            new SimpleReagent(
                    "LAYOUT_STORE",
                    "@layout-store",
                    ReagentType.PHRASE,
                    IUserLayoutStore.class,
