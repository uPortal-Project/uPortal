...
public class ExternalAggregatedGroupMappingComparator
    ...
    public static final ExternalAggregatedGroupMappingComparator INSTANCE =
            new ExternalAggregatedGroupMappingComparator();
    ...
    private ExternalAggregatedGroupMappingComparator() {
        chain =
                new ComparatorChain(
                        Arrays.asList(
                                new ComparableExtractingComparator<
                                        ExternalAggregatedGroupMapping, String>() {
                                    @Override
                                    protected String getComparable(
                                            ExternalAggregatedGroupMapping o) {
