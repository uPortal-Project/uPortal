...
public interface IDataExporter<T> {
    ...
    /**
     * Return a safe file name. Safe is defined as not containing characters that are invalid or
     * difficult to type on common file systems or names that are reserved on common file systems.
     */
