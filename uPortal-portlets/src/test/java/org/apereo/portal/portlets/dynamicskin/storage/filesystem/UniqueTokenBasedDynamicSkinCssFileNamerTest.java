 ...
 * org.apereo.portal.portlets.dynamicskin.storage.filesystem.UniqueTokenBasedDynamicSkinCssFileNamer}.
 */
public class UniqueTokenBasedDynamicSkinCssFileNamerTest {
    ...
    public void generatesProperNameUsingSpecifiedPrefixAndUniqueTokenGenerator() {
        ...
        final UniqueTokenBasedDynamicSkinCssFileNamer namer =
                new UniqueTokenBasedDynamicSkinCssFileNamer(prefix, this.generator);
    ...
    public void generatesProperNameUsingSkinNameAndUniqueTokenGenerator() {
        final UniqueTokenBasedDynamicSkinCssFileNamer namer =
                new UniqueTokenBasedDynamicSkinCssFileNamer(this.generator);
        final String result = namer.generateCssFileName(this.data);
