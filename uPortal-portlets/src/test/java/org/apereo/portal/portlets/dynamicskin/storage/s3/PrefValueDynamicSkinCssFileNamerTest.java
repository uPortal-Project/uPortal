 ...
 * org.apereo.portal.portlets.dynamicskin.storage.s3.PrefValueDynamicSkinCssFileNamer}.
 */
public class PrefValueDynamicSkinCssFileNamerTest {
    ...
    public void throwsExceptionIfPreferenceNotFound() {
        this.preferenceNotFound(
                PrefValueDynamicSkinCssFileNamer.SKIN_CSS_FILE_NAME_PREFERENCE_NAME);
        this.namer.generateCssFileName(this.data);
    }

    @Test(expected = DynamicSkinException.class)
    public void throwsExceptionIfPreferenceValueIsEmpty() {
        this.preferenceFound(
                PrefValueDynamicSkinCssFileNamer.SKIN_CSS_FILE_NAME_PREFERENCE_NAME, "");
        this.namer.generateCssFileName(this.data);
    }
    ...
    public void returnsPreferenceValue() {
        ...
        this.preferenceFound(
                PrefValueDynamicSkinCssFileNamer.SKIN_CSS_FILE_NAME_PREFERENCE_NAME, prefValue);
