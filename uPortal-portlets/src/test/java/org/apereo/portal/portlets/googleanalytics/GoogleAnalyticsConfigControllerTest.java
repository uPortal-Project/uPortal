...
public class GoogleAnalyticsConfigControllerTest {
    ...
    public void testJsonConversion() throws Exception {
        final String json =
                "{\"defaultConfig\":{\"name\":\"Default Property\",\"propertyId\":\"ABCD\",\"config\":[{\"name\":\"f\",\"value\":\"e\"},{\"name\":\"a\",\"value\":\"e\"}],\"dimensionGroups\":[{\"name\":\"r\",\"value\":\"t\"}]},\"institutions\":[{\"name\":\"foobar\",\"propertyId\":\"1234\",\"config\":[],\"dimensionGroups\":[]},{\"name\":\"test\",\"propertyId\":\"\",\"config\":[],\"dimensionGroups\":[]}]}";
