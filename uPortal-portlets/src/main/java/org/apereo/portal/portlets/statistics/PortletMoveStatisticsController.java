...
public class PortletMoveStatisticsController
        extends BasePortletLayoutStatisticsController<PortletMoveReportForm> {
    ...
    public ModelAndView renderPortletAddAggregationReport(PortletMoveReportForm form)
    ...
    protected List<Value> createRowValues(
            PortletLayoutAggregation aggr, PortletMoveReportForm form) {
