...
/**
 * {@link DynamicSkinCssFileNamer} class that uses a {@link DynamicSkinUniqueTokenGenerator} to
 * create unique Dynamic Skin CSS file names. A file prefix can be provided, otherwise the skin name
