...
public class DefaultStatisticsReportLabellingStrategy
    ...
    /**
     * Create report title. Criteria that have a single value selected are put into the title. If
     * only 1 of each item chosen, the 1st item will be a column header and the remaining items will
     * be in the title header. Format and possible options for title are:
     *
     * <ul>
     *   <li>itemX
