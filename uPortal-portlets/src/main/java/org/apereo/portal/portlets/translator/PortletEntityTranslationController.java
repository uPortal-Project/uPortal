...
public class PortletEntityTranslationController {
    ...
    public ModelAndView getPortletDefinition(
            @RequestParam("id") String portletId, @RequestParam("locale") String locale)
            throws Exception {
    ...
    public ModelAndView postPortletTranslation(
            @RequestParam("id") String portletId,
