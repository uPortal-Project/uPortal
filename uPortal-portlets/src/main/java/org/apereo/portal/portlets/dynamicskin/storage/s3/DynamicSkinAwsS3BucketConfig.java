...
/**
 * Class to encapsulate the AWS S3 bucket properties for content. This class should be injected as a
 * dependency into classes that need Content AWS S3 bucket properties values.
 */
@Component
