...
public @interface RequestCache {
    ...
    /**
     * Array of booleans designating which parameters should be used in the key. If the array is
     * empty all parameters are included. If the array length is different than the number of
     * parameters an {@link AnnotationFormatError} is thrown
     */
