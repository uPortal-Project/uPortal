...
public class ResourceUrlProviderImplTest {
    ...
    @Mock private IPortletWindow portletWindowMock;
    ...
    public void testSetAbsoluteURL() {
        ResourceUrlProviderImpl urlProvider =
                new ResourceUrlProviderImpl(portletWindowMock, requestMock);
    ...
    /**
     * Test method for {@link ResourceUrlProviderImpl#equals(Object)} and {@link
     * ResourceUrlProviderImpl#hashCode()}.
     */
    @Test
    public void testEqualsAndHashCode() {
        ResourceUrlProviderImpl urlProvider1 =
                new ResourceUrlProviderImpl(portletWindowMock, requestMock);
        ResourceUrlProviderImpl urlProvider2 =
                new ResourceUrlProviderImpl(portletWindowMock, requestMock);
