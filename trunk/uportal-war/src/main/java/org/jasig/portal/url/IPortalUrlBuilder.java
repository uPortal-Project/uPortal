...
public interface IPortalUrlBuilder extends IUrlBuilder {
    /**
     * @return The layout folder this URL targets, if null {@link #getTargetPortletWindowId()} will not be null.
     */
    public String getTargetFolderId();

    /**
     * @return The portlet window ID this URL targets, if null {@link #getTargetFolderId()} will not be null.
     */
     ...
     * this method with the same id will likely return the same object
     * 
    ...
    /**
     * If {@link #getTargetPortletWindowId()} does not return null this will return the {@link IPortletUrlBuilder}
     * for the returned window id.
    ...
    /**
     * @return All of the portlet url builders that have been created for this portal url. Unmodifiable Map
     */
