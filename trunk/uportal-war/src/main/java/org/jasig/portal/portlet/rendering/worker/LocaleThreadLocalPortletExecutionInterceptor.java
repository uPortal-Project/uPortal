...
public class LocaleThreadLocalPortletExecutionInterceptor extends ThreadLocalPortletExecutionInterceptor<LocaleContext> {
    ...
    @Override
    protected LocaleContext getThreadLocalValue(HttpServletRequest request, HttpServletResponse response,
    ...
    protected void setThreadLocalValue(HttpServletRequest request, HttpServletResponse response,
            IPortletExecutionContext context, LocaleContext value) {
        if (value == null) {
