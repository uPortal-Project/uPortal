...
/**
 * Testcase for PortalException. The PortalException implementation of initCause() catches the
...
public class PortalExceptionTest extends TestCase {
    ...
    /**
     * Test that calling the deprecated legacy method setRecordedException(null) does not throw any
     * exceptions.
     */
    ...
    /** Test that setRecordedException populates the Throwable.getCause() of a PortalException. */
