...
public class FunctionalNameColumnMapperTest {
    ...
    /**
     * Tests the fromNonNullValue method with an invalid input. Expects IllegalArgumentException to
     * be thrown with the correct message.
     */
    @Test
    public void testFromNonNullValueWithInvalidInput() {
        String input = "invalid functional name";
        assertThrows(
                "Value from database 'invalid functional name' does not validate against pattern: "
                        + FunctionalNameType.VALID_FNAME_PATTERN.pattern(),
    ...
    /**
     * Tests the toNonNullValue method with an invalid input. Expects IllegalArgumentException to be
     * thrown with the correct message.
     */
    @Test
    public void testToNonNullValueWithInvalidInput() {
        ...
        assertThrows(
                "Value being stored 'invalid functional name' does not validate against pattern: "
                        + FunctionalNameType.VALID_FNAME_PATTERN.pattern(),
                IllegalArgumentException.class,
                () -> {
