...
public class PortalException extends RuntimeException {
    ...
    /**
     * True if logging is pending on this exception instance (has not yet been logged but
     * potentially will be). True if all the logging that ought to happen has happened.
     */
    ...
    /**
     * Instantiate a generic PortalException. Instantiating a bare, no-message, no ErrorID, no
     * frills PortalException is pretty anti-social. Wouldn't you rather use a constructor that
    ...
    /**
     * Set if the user should be presented with an option to retry the same operation on the
