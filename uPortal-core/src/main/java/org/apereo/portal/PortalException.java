...
public class PortalException extends RuntimeException {
  ...
  /**
   * True if logging is pending on this exception instance (has not yet been logged but potentially
   * will be). True if all the logging that ought to happen has happened.
   */
  ...
  /**
   * Instantiate a generic PortalException. Instantiating a bare, no-message, no ErrorID, no frills
   * PortalException is pretty anti-social. Wouldn't you rather use a constructor that provides more
   * information?
   */
  ...
  /**
   * Creates a new <code>PortalException</code> instance, with a contained text message.
   *
  ...
  /**
   * Set if the user should be presented with an option to retry the same operation on the component
   * that has generated the error.
   *
  ...
  /**
   * Set if the user should be presented with an option to reinstantiate the component (channel)
  ...
  /**
   * Instantiate a PortalException with the given message, underlying cause, refresh, and
   * reinstantiate state.
   *
   * @param msg - message describing the problem
