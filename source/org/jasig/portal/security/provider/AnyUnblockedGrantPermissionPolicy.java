...
public class AnyUnblockedGrantPermissionPolicy
    ...
    public boolean doesPrincipalHavePermission(IAuthorizationService service, IAuthorizationPrincipal principal, String owner, String activity, String target) throws AuthorizationException {
        ...
        Set activePermissions = activePermissions(perms);
        ...
        try {
            ...
            Set seenGroups = new HashSet(100);
    ...
    private boolean hasUnblockedPathToGrant(IAuthorizationService service, IAuthorizationPrincipal principal, String owner, String activity, String target, Set seenGroups) throws GroupsException {
        ...
        while (immediatelyContainingGroups.hasNext()) {
            ...
            try {
                if (parentGroup != null) {
                    ...
                    Set activeParentPermissions = activePermissions(parentPermissions);
     ...
     */
    private Set activePermissions(final IPermission[] perms) {
        Date now = new Date();

        Set activePermissions = new HashSet(1);
     ...
     */
    private boolean containsType(final Set permissions, final String soughtType) {
        ...
        for (Iterator permissionIter = permissions.iterator(); permissionIter.hasNext(); ) {
            IPermission permission = (IPermission) permissionIter.next();
