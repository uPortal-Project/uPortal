...
class ModernFlyoutNav {
    ...
    init() {
        this.flyoutMenu = this.container.querySelector(
            this.options.selectors.flyoutMenu
        );
        this.flyoutList = this.container.querySelector(
            this.options.selectors.flyoutList
        );
        const dropdownToggle = this.container.querySelector(
            this.options.selectors.dropdownToggle
        );
    ...
    bindEvents() {
        ...
        if (this.dropdownToggle) {
            this.dropdownToggle.addEventListener('click', (event_) => {
    ...
    calculatePosition() {
        ...
        if (this.options.orientation === 'horizontal') {
            ...
            left =
                this.options.horzalign === 'left'
                    ? 0
                    : containerRect.width - flyoutRect.width;

            top =
                this.options.vertalign === 'bottom'
