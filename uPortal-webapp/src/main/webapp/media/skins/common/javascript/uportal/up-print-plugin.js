    ...
    $('.up-portlet-controls').ready(function() {
        $('a.up-portlet-control.print').each(function(i) {
            ...
            var printPortlet = function(id) {
                ...
                sOption +=
                    'scrollbars=yes,width=750,height=600,left=100,top=25,resizable=yes';
                        ...
                        if (
                            ...
                            if (
                                ...
                                className = className.replace(
                                    new RegExp('layout-.-columns', 'gi'),
                                    'layout-1-columns'
                                );
                                className = className.replace(
                                    new RegExp('fl-col-flex.', 'gi'),
                                    'fl-col-flex1'
                                );
                                className = className.replace(
                                    new RegExp('left', 'gi'),
                ...
                html += htmlTree;
                html +=
                    '<div id="portletContent_' +
                    id +
                    '" class="' +
                    $('#portletContent_' + id).get(0).className +
                    '">';
                // class="fl-widget-content fl-fix up-portlet-content-wrapper"
                html += $('#portletContent_' + id)
                    .clone()
                    .html();
                html += '</div>';
