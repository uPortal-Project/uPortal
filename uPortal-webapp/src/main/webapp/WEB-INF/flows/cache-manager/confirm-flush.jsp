...
<!-- Portlet -->
<div class="card portlet cache-mgr view-flush" role="section">
	<!-- Portlet Titlebar -->
    ...
    <div class="card-body content portlet-content">
        ...
        <form action="${formUrl}" method="POST">
            <div class="buttons">
            	<input class="button btn primary" type="submit" value="<spring:message code="empty.cache"/>" name="_eventId_confirm"/>
