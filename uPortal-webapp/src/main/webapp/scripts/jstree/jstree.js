 ...
 */
  ...
  $.jstree.core.prototype = {
            ...
            switch (e.which) {
              ...
              case 39: // left
                ...
                if (this.is_closed(e.currentTarget)) {
                  ...
                  o = this.get_node(e.currentTarget, true).children(
                    '.jstree-children',
                  )[0]
                  if (o) {
                    $(this._firstChild(o))
      ...
      if (obj.state.loaded) {
        ...
        for (k = 0, l = obj.children_d.length; k < l; k++) {
          for (i = 0, j = obj.parents.length; i < j; i++) {
            this._model.data[
              obj.parents[i]
            ].children_d = $.vakata.array_remove_item(
    ...
    _load_node: function(obj, callback) {
      ...
      if ($.isFunction(s)) {
        return s.call(
          ...
          $.proxy(function(d) {
            ...
            this[
              typeof d === 'string' ? '_append_html_data' : '_append_json_data'
            ](
              obj,
              typeof d === 'string'
                ? $($.parseHTML(d)).filter(function() {
      ...
      if (typeof s === 'object') {
        ...
        t =
          $.isArray(s) || $.isPlainObject(s) ? JSON.parse(JSON.stringify(s)) : s
        if (obj.id === '#') {
      ...
      var w = null,
        ...
        func = function(data, undefined) {
          ...
          if (
            ...
            for (i = 0, j = p.parents.length; i < j; i++) {
              m[p.parents[i]].children_d = m[p.parents[i]].children_d.concat(
                dpc,
              )
            }
    ...
    redraw_node: function(node, deep, is_callback, force_render) {
      ...
      if (!node) {
        ...
        if (!is_callback) {
          ...
          ind = $.inArray(
            obj.id,
            par === null ? m['#'].children : m[obj.parent].children,
          )
        }
      } else {
        node = $(node)
      ...
      if (!this.is_loaded(obj)) {
        ...
        this.load_node(obj, function(o, ok) {
          return ok
            ...
            : callback ? callback.call(this, o, false) : false
        })
      } else {
    ...
    open_all: function(obj, animation, original_obj) {
      ...
      var dom =
          obj.id === '#' ? this.get_container_ul() : this.get_node(obj, true),
        i,
        j,
        _this
      if (!dom.length) {
    ...
    set_id: function(obj, id) {
      ...
      if (i) {
        i
          ...
          .attr('id', id + '_anchor')
          .end()
          .attr('aria-labelledby', id + '_anchor')
    ...
    get_json: function(obj, options, flat) {
      ...
      var tmp = {
          ...
          state: {},
          data:
            options && options.no_data ? false : $.extend(true, {}, obj.data),
    ...
    create_node: function(par, node, pos, callback, is_loaded) {
      ...
      for (i = 0, j = par.parents.length; i < j; i++) {
        this._model.data[par.parents[i]].children_d = this._model.data[
          par.parents[i]
        ].children_d.concat(dpc)
      }
      node = tmp
      tmp = []
    ...
    delete_node: function(obj) {
      ...
      for (k = 0, l = tmp.length; k < l; k++) {
        for (i = 0, j = obj.parents.length; i < j; i++) {
          ...
          if (pos !== -1) {
            this._model.data[obj.parents[i]].children_d = $.vakata.array_remove(
              this._model.data[obj.parents[i]].children_d,
              pos,
            )
          }
        ...
        if (this._model.data[tmp[k]].state.selected) {
          ...
          if (pos !== -1) {
            this._data.core.selected = $.vakata.array_remove(
              this._data.core.selected,
              pos,
            )
          }
    ...
    move_node: function(
      ...
      new_par =
        !pos.toString().match(/^(before|after)$/) || par.id === '#'
          ? par
      ...
      if (obj.parent === new_par.id) {
        ...
        for (i = 0, j = new_par.parents.length; i < j; i++) {
          this._model.data[new_par.parents[i]].children_d = this._model.data[
            new_par.parents[i]
          ].children_d.concat(tmp)
        }
        dpc = []
        ...
        this.element
            ...
            $.proxy(function(e, data) {
              ...
              if (s.indexOf('down') !== -1) {
                this._data[
                  ...
                  this._data[t ? 'core' : 'checkbox'].selected.concat(
                    obj.children_d,
                  ),
                )
                for (i = 0, j = obj.children_d.length; i < j; i++) {
          ...
          .on(
            ...
            $.proxy(function(e, data) {
              ...
              tmp = []
              for (
                i = 0, j = this._data[t ? 'core' : 'checkbox'].selected.length;
                i < j;
                i++
              ) {
                // apply down + apply up
                if (
                  (s.indexOf('down') === -1 ||
                    $.inArray(
                      this._data[t ? 'core' : 'checkbox'].selected[i],
                      obj.children_d,
                    ) === -1) &&
                  (s.indexOf('up') === -1 ||
                    $.inArray(
              ...
              this._data[
                t ? 'core' : 'checkbox'
              ].selected = $.vakata.array_unique(tmp)
              ...
              while (p && p.id !== '#') {
                ...
                if (c === j) {
                  ...
                  if (p.state[t ? 'selected' : 'checked']) {
                    ...
                    this._data[
                      t ? 'core' : 'checkbox'
                    ].selected = $.vakata.array_remove_item(
                      this._data[t ? 'core' : 'checkbox'].selected,
                      p.id,
                    )
                    tmp = this.get_node(p, true)
    ...
    $.vakata.context = {
      ...
      _parse: function(o, is_callback) {
        ...
        $.each(o, function(i, val) {
          ...
          str +=
            ...
            '>'
          str +=
            '<' + "a href='#' rel='" + (vakata_context.items.length - 1) + "'>"
      ...
      _show_submenu: function(o) {
        ...
        if (right_to_left) {
          ...
          o[x + w + 10 > dw ? 'addClass' : 'removeClass'](
  ...
  ;(function($) {
    ...
    $.vakata.dnd = {
      ...
      start: function(e, data, html) {
        ...
        if (html !== false) {
          vakata_dnd.helper = $("<div id='vakata-dnd'></div>")
            .html(html)
            .css({
              display: 'block',
              margin: '0',
  ...
  $.jstree.plugins.types = function(options, parent) {
    ...
    this.check = function(chk, obj, par, pos, more) {
      ...
      var m =
          obj && obj.id
            ? more && more.origin ? more.origin : $.jstree.reference(obj.id)
            : null,
        tmp,
        d,
        i,
    ...
    this.set_type = function(obj, type) {
      ...
      if (
        old_icon === true ||
        (t[old_type] &&
          t[old_type].icon !== undefined &&
          old_icon === t[old_type].icon)
      ) {
  ...
  $.jstree.plugins.unique = function(options, parent) {
    this.check = function(chk, obj, par, pos, more) {
      ...
      for (i = 0, j = par.children.length; i < j; i++) {
        c.push(
          s ? m[par.children[i]].text : m[par.children[i]].text.toLowerCase(),
        )
      }
      if (!s) {
        n = n.toLowerCase()
      ...
      switch (chk) {
        ...
        case 'rename_node':
          i =
            $.inArray(n, c) === -1 ||
            (obj.text && obj.text[s ? 'toString' : 'toLowerCase']() === n)
          if (!i) {
            this._data.core.last_error = {
              error: 'check',
              plugin: 'unique',
