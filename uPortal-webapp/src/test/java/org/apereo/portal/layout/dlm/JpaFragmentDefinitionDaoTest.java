...
public class JpaFragmentDefinitionDaoTest extends BasePortalJpaDaoTest {
    @Autowired private IFragmentDefinitionDao dao;
        ...
        this.execute(
                new Callable<Object>() {
                    ...
                    public Object call() throws Exception {
                        ...
                        final FragmentDefinition nullFd =
                                dao.getFragmentDefinition("THIS_IS_NOT_IN_FACT_A_FRAGMENT");
                        assertNull(nullFd);

                        final FragmentDefinition fakeFd =
                                MockFragmentDefinition.newFragmentDefinition(
                                        "THIS_IS_NOT_IN_FACT_A_FRAGMENT");
    ...
    public void testAllMethods() throws Exception {
        this.execute(
                new Callable<Object>() {
                    @Override
                    public Object call() throws Exception {
                        FragmentDefinition foo1 =
                                MockFragmentDefinition.newFragmentDefinition("foo");
                        dao.updateFragmentDefinition(foo1);
                        FragmentDefinition bar1 =
                                MockFragmentDefinition.newFragmentDefinition("bar");
