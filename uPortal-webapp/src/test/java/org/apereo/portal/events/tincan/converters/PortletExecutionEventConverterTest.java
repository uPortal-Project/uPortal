...
import org.apereo.portal.events.MockPortletExecutionEvent;
...
public class PortletExecutionEventConverterTest {
    ...
    private boolean setupSupportsTest(
            String fname, boolean classMatch, boolean fnameMatch, FNameFilterType filterType) {
        ...
        List<Class<? extends PortletExecutionEvent>> classes =
                new ArrayList<Class<? extends PortletExecutionEvent>>();
