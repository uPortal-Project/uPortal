...
public class JpaPortletExecutionAggregationDaoTest
    ...
    @Override
    protected Map<PortletExecutionAggregationKey, PortletExecutionAggregationImpl>
            createAggregations(
                    AggregationIntervalInfo intervalInfo, AggregatedGroupMapping aggregatedGroup) {
        ...
        return Collections
                .<PortletExecutionAggregationKey, PortletExecutionAggregationImpl>singletonMap(
                        key, aggr);
    }
}
