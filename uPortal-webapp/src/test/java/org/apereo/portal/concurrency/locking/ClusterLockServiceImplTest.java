...
public class ClusterLockServiceImplTest {
    @InjectMocks
    private final ClusterLockServiceImpl clusterLockService = new ClusterLockServiceImpl();
    ...
    public void testWithinLastRunDelay() throws InterruptedException {
        ...
        when(clusterLockDao.getLock(mutexName))
                .thenAnswer(
                        new Answer<ClusterMutex>() {
                            @Override
                            public ClusterMutex answer(InvocationOnMock invocation)
                                    throws Throwable {
                                clusterMutex.lock(serverName);
                                return clusterMutex;
                            }
        ...
        final TryLockFunctionResult<Boolean> result =
                this.clusterLockService.doInTryLock(
                        mutexName,
                        LockOptions.builder().lastRunDelay(1000),
    ...
    public void testOutsideLastRunDelay() throws InterruptedException {
        ...
        final TryLockFunctionResult<Boolean> result =
                this.clusterLockService.doInTryLock(
                        mutexName,
                        LockOptions.builder().lastRunDelay(10),
                        new Function<ClusterMutex, Boolean>() {
                            @Override
                            public Boolean apply(ClusterMutex input) {
                                return Boolean.TRUE;
    ...
    public void testWithinServerBiasDelayDifferentServer() throws InterruptedException {
        ...
        final TryLockFunctionResult<Boolean> result =
                this.clusterLockService.doInTryLock(
                        mutexName,
                        LockOptions.builder().serverBiasDelay(1000),
                        new Function<ClusterMutex, Boolean>() {
                            @Override
                            public Boolean apply(ClusterMutex input) {
                                return Boolean.TRUE;
    ...
    public void testOutsideServerBiasDelayDifferentServer() throws InterruptedException {
        ...
        final TryLockFunctionResult<Boolean> result =
                this.clusterLockService.doInTryLock(
                        mutexName,
                        LockOptions.builder().serverBiasDelay(10),
                        new Function<ClusterMutex, Boolean>() {
                            @Override
                            public Boolean apply(ClusterMutex input) {
                                return Boolean.TRUE;
    ...
    public void testLockThreadPoolDead() throws InterruptedException {
        ...
        when(fakeLockMonitorExecutorService.submit(any(Callable.class)))
                .thenReturn(dbLockWorkerFuture);
