 ...
 * but it's not a match for what {@link BaseJpaDaoTest} does because it doesn't implement
 * <code>MethodInterceptor</code> from AOP Alliance.
 *
 * @since 5.0
 */
public class PortalJpaInterceptor extends EntityManagerFactoryAccessor implements MethodInterceptor {
