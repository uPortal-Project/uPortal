...
public class UserAccountHelperTest {
    ...
    public void setUp() {
        ...
        when(messageSource.getMessage(
                ...
                .thenReturn("Net ID");
        when(messageSource.getMessage(
                        "attribute.displayName.user.login.id",
                        new Object[] {},
                        "user.login.id",
                        locale))
                .thenReturn("Net ID");
        when(messageSource.getMessage(
                        "attribute.displayName.mail", new Object[] {}, "mail", locale))
                .thenReturn("Email");
        when(messageSource.getMessage(
    ...
    public void testMatchingDisplayAttributes() {
        ...
        final List<GroupedPersonAttribute> displayed =
                helper.groupPersonAttributes(person, request);
