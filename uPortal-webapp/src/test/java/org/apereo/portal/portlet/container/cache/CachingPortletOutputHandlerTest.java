...
public class CachingPortletOutputHandlerTest {
    ...
    public void testBasicWriterCaching() throws IOException {
        final CachingPortletOutputHandler cachingOutputHandler =
                new CachingPortletOutputHandler(portletOutputHandler, 10000);

        when(portletOutputHandler.getPrintWriter())
                .thenReturn(new PrintWriter(NullWriter.NULL_WRITER));
    ...
    public void testTooMuchWriterContent() throws IOException {
        final CachingPortletOutputHandler cachingOutputHandler =
                new CachingPortletOutputHandler(portletOutputHandler, 100);
    ...
    public void testBasicStreamCaching() throws IOException {
        ...
        when(portletOutputHandler.getOutputStream())
                .thenReturn(NullOutputStream.NULL_OUTPUT_STREAM);
