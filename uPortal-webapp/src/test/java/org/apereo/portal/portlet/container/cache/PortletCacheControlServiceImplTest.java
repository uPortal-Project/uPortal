...
public class PortletCacheControlServiceImplTest {
    @InjectMocks
    private PortletCacheControlServiceImpl cacheControlService =
            new PortletCacheControlServiceImpl();
    ...
    public void getCaches() {
        cacheManager =
                new CacheManager(
                        this.getClass().getResource("/portletCacheControlServiceTestEhcache.xml"));
        ...
        cacheControlService.setPrivateScopePortletRenderHeaderOutputCache(
                privateScopeRenderHeaderCache);
        cacheControlService.setPublicScopePortletRenderHeaderOutputCache(
                publicScopeRenderHeaderCache);
    ...
    public void testCachePrivateRenderRoundTrip() {
        ...
        when(this.urlSyntaxProvider.getPortalRequestInfo(httpRequest))
