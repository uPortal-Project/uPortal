...
public class LimitingTeeOutputStreamTest {
    ...
    public void testControl() throws IOException {
        ...
        LimitingTeeOutputStream stream =
                new LimitingTeeOutputStream(
                        content.length, NullOutputStream.NULL_OUTPUT_STREAM, byteStream);
    ...
    public void testContentExceedsThreshold() throws IOException {
        ...
        LimitingTeeOutputStream stream =
                new LimitingTeeOutputStream(
                        content.length - 1, NullOutputStream.NULL_OUTPUT_STREAM, byteStream);
        stream.write(content);
