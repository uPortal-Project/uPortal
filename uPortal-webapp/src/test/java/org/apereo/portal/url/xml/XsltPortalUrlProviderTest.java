...
public class XsltPortalUrlProviderTest {
    ...
    public void setup() throws Exception {
        ...
        xslTemplate =
                tFactory.newTemplates(
                        new StreamSource(this.getClass().getResourceAsStream("test.xsl")));
    ...
    public void testDefaultUrl() throws Exception {
        ...
        when(portalUrlBuilder.getUrlString())
                .thenReturn("/uPortal/home/normal/render.uP?layoutUrl");
    ...
    public void testMultiPortletUrlById() throws Exception {
        ...
        when(portalUrlBuilder.getPortletUrlBuilder(portletWindowId2))
                .thenReturn(portletUrlBuilder2);
