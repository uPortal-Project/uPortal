...
public class MockPortletEntityId implements IPortletEntityId {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.portletEntityId, rhs.getStringId()).isEquals();
    }

    /** @see java.lang.Object#hashCode() */
    @Override
    public int hashCode() {
        return new HashCodeBuilder(-917388291, 674832463).append(this.portletEntityId).toHashCode();
    }
