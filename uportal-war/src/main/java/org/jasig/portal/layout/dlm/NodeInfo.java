...
/**
 * Simple tuple that holds onto metadata about a layout node while the Composite Layout is being calculated.
 * @since uPortal 2.5
 */
public class NodeInfo {
    ...
    public String toString() {
        return "NodeInfo [node=" + node + ", id=" + id + ", precedence=" + precedence + ", differentParent="
                + differentParent + ", indexInCVP=" + indexInCVP + ", positionDirective=" + positionDirective + "]";
    }
