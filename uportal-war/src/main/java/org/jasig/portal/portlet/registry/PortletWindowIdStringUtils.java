 ...
 * 
 * A portlet window ID string is a portlet entity ID string that may contain a period separator and a portlet window instance ID.
 * Formats:
 *   <portlet-entity-id>
 ...
 *   88_n149_52
 *   71_u54_12.2
 *   10_ctf2_32.tw // the 'ctf' and 'tw' here are specific to transient portlets
 * 
...
public class PortletWindowIdStringUtils {
    ...
    /**
     * Parses parts of the portlet window ID string.
     * For input "88_n149_52", should return: { "88_n149_52" }
     * For input "88_n149_52.tw", should return: { "88_n149_52", "tw" }
     * For input "88_n149_52.1.2", should return: { "88_n149_52", "1", "2" } // note that the input here is invalid due to having too many parts
     * For input "146_dlg-5-ctf1-18.tw_18", should return: { "146_dlg-5-ctf1-18.tw_18" }
     * For input "146_dlg-5-ctf1-18.tw_18.1", should return: { "146_dlg-5-ctf1-18.tw_18", "1" }
     */
    private static String[] parseParts(final String portletWindowIdString) {
        ...
        final UserIdAndOtherParts userIdAndOtherParts = parseUserIdAndOtherParts(portletWindowIdString);
        if (userIdAndOtherParts.portletWindowInstanceId == null) {
            return new String[] { portletWindowIdString };
        }
        else {
            final String portletDefinitionId = PortletEntityIdStringUtils.parsePortletDefinitionId(portletWindowIdString);
            final String layoutNodeId = PortletEntityIdStringUtils.parseLayoutNodeId(portletWindowIdString);
            final String portletEntityId = PortletEntityIdStringUtils.format(portletDefinitionId, layoutNodeId, userIdAndOtherParts.userId);
            return createPartsArray(portletEntityId, userIdAndOtherParts.portletWindowInstanceId, userIdAndOtherParts.extraParts);
        }
    }

    private static String[] createPartsArray(final String portletEntityId, final String portletWindowInstanceId, final String[] extraParts) {
    ...
    private static UserIdAndOtherParts parseUserIdAndOtherParts(final String portletWindowIdString) {
    ...
    static class UserIdAndOtherParts {
        ...
        public int getPartsCount() {
            return (userId == null) ? 0 : (portletWindowInstanceId == null) ? 1 : (extraParts == null) ? 2 : 2 + extraParts.length;
        }
    }
