...
public class ImportExportController {
    ...
    public void importEntity(@RequestParam("fileData") MultipartFile entityFile, HttpServletRequest request, HttpServletResponse response) throws DocumentException, IOException {
