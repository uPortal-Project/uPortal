...
package org.jasig.portal.fragment.subscribe.dao;
...
public interface IUserFragmentSubscriptionDao {
    ...
    /**
     * Creates, initializes and persists a new {@link IUserFragmentSubscription} based on the specified 
     * person, and fragment owner.  The subscription will always be created as active.
     * 
     ...
     * @param person the logged in person.
     * @param fragmentOwner the person object representing the fragment owner
     * @return The user fragment subscription for the person and fragment owner, null if no definition exists for the id.
     */
     ...
     * @return The user fragment subscription for the userFragmentInfoId, null if no definition exists for the id.
     */
