...
/**
 * Provides APIs for creating, storing and retrieving {@link IPersonAttributeGroupTestDefinition} objects.
 * 
 * @author Shawn Connolly, sconnolly@unicon.net
 */
public interface IPersonAttributeGroupTestDefinitionDao {
