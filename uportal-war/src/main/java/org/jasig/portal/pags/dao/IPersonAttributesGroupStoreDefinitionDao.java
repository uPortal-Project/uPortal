...
/**
 * Provides APIs for creating, storing and retrieving {@link IPersonAttributesGroupStoreDefinition} objects.
 * 
 * @author Shawn Connolly, sconnolly@unicon.net
 */
public interface IPersonAttributesGroupStoreDefinitionDao {
