...
public class GrouperEntityGroupStore implements IEntityGroupStore,
	 ...
	 * 
	 * @see
	 * org.jasig.portal.groups.IEntityGroupStore#contains(org.jasig.portal.groups
	 * .IEntityGroup, org.jasig.portal.groups.IGroupMember)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.jasig.portal.groups.IEntityGroupStore#findContainingGroups(org.jasig
	 * .portal.groups.IGroupMember)
	 */
	public Iterator<IEntityGroup> findContainingGroups(IGroupMember gm)
			throws GroupsException {
	 ...
	 * 
	 * @see
	 * org.jasig.portal.groups.IEntityGroupStore#findEntitiesForGroup(org.jasig
	 * .portal.groups.IEntityGroup)
	 */
	public Iterator<IGroupMember> findEntitiesForGroup(IEntityGroup group)
			throws GroupsException {
	 ...
	 * 
	 * @see
	 * org.jasig.portal.groups.IEntityGroupStore#findMemberGroupKeys(org.jasig
	 * .portal.groups.IEntityGroup)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * org.jasig.portal.groups.IEntityGroupStore#searchForGroups(java.lang.String
	 * , int, java.lang.Class)
	 */
	public EntityIdentifier[] searchForGroups(final String query,
			final int method, @SuppressWarnings("rawtypes") final Class type) {
		...
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("Searching Grouper for groups matching query: "
					+ query);
		}
	...
	/**
	 * Test a Grouper {WsGroup} against a query string according to the
	 * specified method and determine if it matches the query.
	 * 
	 * @param group
	 *            WsGroup to be tested
	 * @param query
	 *            Query string
	 * @param method
	 *            int-based method matching one of the standard search methods
	...
	/**
	 * Get the prefix for the stem containing uPortal groups. If this value is
	 * non-empty, all groups will be required to be prefixed with the specified
	 * stem name.
	 * 
	...
	protected static boolean validKey(String key) {
		...
		if (!StringUtils.isBlank(uportalStem)
				&& (StringUtils.isBlank(key) || !key.startsWith(uportalStem
						.concat(":")))) {
	 ...
	 */
	@Override
	public IEntityGroup newInstance(
			@SuppressWarnings("rawtypes") Class entityType)
			throws GroupsException {
		throw new UnsupportedOperationException(
