...
/**
 * Runtime exception for the SkinManager.  Avoids having to carry IOException and other checked exceptions through
 * method signatures.
 *
...
public class SkinManagerException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected SkinManagerException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
