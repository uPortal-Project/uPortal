...
public interface ConditionalExceptionLogger extends Logger {
     ...
     * info(msg + t.getMesage());
     * If debug level is enabled logs:
     * info(msg, t); 
     */
    public void infoDebug(String msg, Throwable t);
    
    /**
     * If warn level is enabled logs:
     * warn(msg + t.getMesage());
     * If debug level is enabled logs:
     * warn(msg, t); 
     */
    ...
    /**
     * If error level is enabled logs:
     * error(msg + t.getMesage());
     * If debug level is enabled logs:
     * error(msg, t); 
     */
     ...
     * If info level is enabled logs:
     * info(msg + t.getMesage());
     * If trace level is enabled logs:
     * info(msg, t); 
     */
