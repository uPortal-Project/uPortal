...
public class MonthDayTypeDescriptor extends AbstractTypeDescriptor<MonthDay> {
    ...
    private MonthDayTypeDescriptor() {
    ...
    @Override
    public <X> X unwrap(MonthDay value, Class<X> type, WrapperOptions options) {
        if ( value == null ) {
            return null;
        }
    ...
    @Override
    public <X> MonthDay wrap(X value, WrapperOptions options) {
        if ( value == null ) {
            return null;
        }
