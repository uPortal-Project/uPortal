 ...
 * @version $Revision$
 */
public class JacksonTypeDescriptor extends AbstractTypeDescriptor<Object> {
    private static final long serialVersionUID = 1L;
    public static final JacksonTypeDescriptor INSTANCE = new JacksonTypeDescriptor();

    private JacksonTypeDescriptor() {
        super(Object.class, ObjectMutabilityPlan.INSTANCE);
    }
