...
/**
 * Servlet filter to trigger {@link IPortalCookie} deletion.
 * Should be applied to the /Logout url.
 * 
 * @author Nicholas Blair
 * @version $Id$
 */
public class DestroyPortletCookieFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request,
		...
		if(portalCookie != null) {
			IPortalCookie _portalCookie = this.portletCookieDao.getPortalCookie(portalCookie.getValue());
			this.portletCookieDao.deletePortalCookie(_portalCookie);
			
			portalCookie.setMaxAge(0);
