 ...
 * @version $Revision$
 */
public class PortletHeaderPlaceholderEventSource implements CharacterEventSource {
    ...
    public List<CharacterEvent> getCharacterEvents(XMLEventReader eventReader, StartElement event) throws XMLStreamException {
        ...
        return Arrays.asList((CharacterEvent)new PortletHeaderPlaceholderEventImpl(id));
    }
