 ...
 * @version $Revision$
 */
public class PortletContentPlaceholderEventImpl implements PortletContentPlaceholderEvent {
    private static final long serialVersionUID = 1L;

    
    private final String portletWindowId;
    
    public PortletContentPlaceholderEventImpl(String portletWindowId) {
    ...
    public String toString() {
        return "PortletContentPlaceholderEventImpl [portletWindowId=" + this.portletWindowId + "]";
    }
}
