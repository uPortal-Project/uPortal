...
/**
 * Base class for {@link XMLEventReader}s for classes that want to inject additional events into the stream.
 * 
...
public abstract class InjectingXMLEventReader extends BaseXMLEventReader {
    ...
    /**
     * Called by {@link #getAdditionalEvents(XMLEvent)} and then wrapped with a {@link Deque}. If there is a need to
     * inject more than a single event override {@link #getAdditionalEvents(XMLEvent)}
     */
