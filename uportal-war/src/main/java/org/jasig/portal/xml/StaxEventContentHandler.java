...
public class StaxEventContentHandler extends AbstractStaxContentHandler {
    ...
    protected void startElementInternal(QName name, Attributes atts, SimpleNamespaceContext namespaceContext)
        ...
        Iterator attributes = getAttributes(atts);
        Iterator namespaces = createNamespaces(namespaceContext);
        consumeEvent(eventFactory.createStartElement(name, attributes, namespaces));
    }

    @Override
    protected void endElementInternal(QName name, SimpleNamespaceContext namespaceContext) throws XMLStreamException {
        Iterator namespaces = createNamespaces(namespaceContext);
        consumeEvent(eventFactory.createEndElement(name, namespaces));
    }
    ...
    private Iterator<Namespace> createNamespaces(SimpleNamespaceContext namespaceContext) {
    ...
    private Iterator<Attribute> getAttributes(Attributes attributes) {
