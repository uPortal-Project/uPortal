 ...
 * @version $Revision$
 */
public final class ResourceLoaderURIResolver implements URIResolver, ResourceLoaderAware {
    ...
    public Source resolve(String href, String base) throws TransformerException {
        ...
        if (base != null) {
            resource = this.resourceLoader.getResource(base + href);
        }
        else {
            resource = this.resourceLoader.getResource(href);
        }
        ...
        try {
            ...
            throw new TransformerException("Failed to get InputStream for " + resource, e);
        }
