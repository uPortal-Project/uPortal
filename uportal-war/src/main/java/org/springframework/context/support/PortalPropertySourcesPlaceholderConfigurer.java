...
public class PortalPropertySourcesPlaceholderConfigurer
  ...
  /**
   * uPortal defines some properties files in its primaryPropertyPlaceholderConfigurer bean that are
   * considered (and documented) optional. The parent class (PropertySourcesPlaceholderConfigurer)
   * will operate properly without them, but puts a significant number of WARN messages into the
   * log. These are noisy, and could lead a new adopter to think that something's wrong. This method
   * removes absent properties files from the collection.
   */
  @Override
