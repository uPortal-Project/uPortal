...
public class BasicAuthInterceptor implements ClientHttpRequestInterceptor {
  ...
  public ClientHttpResponse intercept(
      HttpRequest req, byte[] bytes, ClientHttpRequestExecution execution) throws IOException {
  ...
  private synchronized String getAuthHeader() {
    if (authHeader == null) {
      String authCode =
          propertyResolver.getProperty("org.jasig.rest.interceptor.basic-auth." + id + ".authCode");
