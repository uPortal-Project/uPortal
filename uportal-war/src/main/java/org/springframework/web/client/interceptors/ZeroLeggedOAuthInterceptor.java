...
/**
 * Interceptor to add the authorization headers required for 0-legged oauth signing
 * of requests.
 *
...
public class ZeroLeggedOAuthInterceptor implements ClientHttpRequestInterceptor {
    ...
    private static class RealmOAuthConsumer extends OAuthConsumer {
        ...
        public RealmOAuthConsumer(final String consumerKey, final String consumerSecret,
                final String realm, final OAuthServiceProvider serviceProvider) {
