...
public class DelegationRequest {
  ...
  public int hashCode() {
    ...
    result =
        prime * result + ((this.parentParameters == null) ? 0 : this.parentParameters.hashCode());
    result =
        prime * result + ((this.parentPortletMode == null) ? 0 : this.parentPortletMode.hashCode());
    result =
        prime * result + ((this.parentWindowState == null) ? 0 : this.parentWindowState.hashCode());
    return result;
  }
  /* (non-Javadoc)
