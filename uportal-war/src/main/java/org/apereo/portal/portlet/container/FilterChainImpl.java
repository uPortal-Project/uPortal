...
public class FilterChainImpl implements FilterChain {
  ...
  public void processFilter(
      EventRequest req, EventResponse res, EventPortlet eventPortlet, PortletContext portletContext)
    ...
    if (filterListIndex < filterList.size()) {
      ...
      try {
        ...
        FilterConfigImpl filterConfig =
            new FilterConfigImpl(filter.getFilterName(), filter.getInitParams(), portletContext);
