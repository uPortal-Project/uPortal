...
public interface IPortletRenderer {
  ...
  /**
   * Name of the {@link PortletRequest} property that the portlet should use to set a new-item-count
   * value.
   */
  public static final String NEW_ITEM_COUNT_PROPERTY = "org.jasig.portlet.NEW_ITEM_COUNT";

  /**
   * Name of the {@link PortletRequest} property that the portlet should use to set an external link
   */
  ...
  /**
   * Attribute that the renderer stores a {@link CacheControl} that should be used when the portlet
   * writes out content.
   */
