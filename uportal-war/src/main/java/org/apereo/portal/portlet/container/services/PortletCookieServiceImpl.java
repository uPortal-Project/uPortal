...
public class PortletCookieServiceImpl implements IPortletCookieService, ServletContextAware {
    ...
    @Value("${org.apereo.portal.portlet.container.services.PortletCookieServiceImpl.purgeExpiredCookiesPeriod}")
	 ...
	 */
    @Value("${org.apereo.portal.portlet.container.services.PortletCookieServiceImpl.portalCookieAlwaysSecure}")
     ...
     * 
     * (non-Javadoc)
     * @see org.apereo.portal.portlet.container.services.IPortletCookieService#updatePortalCookie(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    @Override
