...
class TransientPortletEntity implements IPortletEntity {
  ...
  public int hashCode() {
    ...
    result =
        prime * result
            + ((this.transientLayoutNodeId == null) ? 0 : this.transientLayoutNodeId.hashCode());
    result =
        prime * result
            + ((this.delegatePortletEntity.getPortletDefinition() == null)
                ? 0
                : this.delegatePortletEntity.getPortletDefinition().hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!this.transientLayoutNodeId.equals(other.getLayoutNodeId())) return false;
    if (this.delegatePortletEntity.getPortletDefinition() == null) {
      if (other.getPortletDefinition() != null) return false;
    } else if (!this.delegatePortletEntity
        .getPortletDefinition()
        .equals(other.getPortletDefinition())) return false;
    if (this.delegatePortletEntity.getUserId() != other.getUserId()) return false;
    return true;
  }
  ...
  public String toString() {
    return "PortletEntity ["
        + "portletEntityId="
        + this.delegatePortletEntity.getPortletEntityId()
        + ", "
        + "layoutNodeId="
        + this.transientLayoutNodeId
        + ", "
        + "userId="
        + this.delegatePortletEntity.getUserId()
        + ", "
        + "portletDefinition="
        + this.delegatePortletEntity.getPortletDefinition()
        + "]";
  }
}
