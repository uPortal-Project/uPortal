...
public interface IPortletWindow extends IPortletWindowDescriptor {
  ...
  /**
   * @return The ID of the parent portlet window that is delegating rendering to this portlet, null
   *     if this portlet is not being delegated to.
   */
  ...
  /**
   * @return Hash code based on the {@link #getPortletEntity()}, {@link #getPortletWindowId()}, and
   *     {@link #getDelegationParentId()}
   */
  @Override
  public int hashCode();
