...
/**
 * Encapsulates logic related to handling properties that can be retrieved from and set on {@link
 * javax.portlet.PortletRequest} and {@link javax.portlet.PortletResponse} objects.
 *
...
public interface IRequestPropertiesManager {
  ...
  /**
   * Called when a portlet sets a property via {@link
   * javax.portlet.PortletResponse#setProperty(String, String)}. This method should follow the same
   * rules as the PortletResponse method and overwrite any existing property of the same name.
   *
  ...
  /**
   * Called when a portlet sets a property via {@link
   * javax.portlet.PortletResponse#addProperty(String, String)}. This method should follow the same
   * rules as the PortletResponse method and add the value to any existing property of the same
   * name.
   *
  ...
  /**
   * Called when a portlet gets the request properties via {@link
   * javax.portlet.PortletRequest#getProperties(String)}, {@link
   * javax.portlet.PortletRequest#getProperty(String)}, or {@link
   * javax.portlet.PortletRequest#getPropertyNames()}.
   *
   * @param portletRequest The request the get call was made during
   * @param portletWindow The PortletWindow representing the portlet calling addProperty
   * @param propertiesPopulator Populator to add properties to, for multi-valued properties call
   *     {@link Populator#put(Object, Object)} multiple times
   */
  public <P extends Populator<String, String>> void populateRequestProperties(
      HttpServletRequest portletRequest, IPortletWindow portletWindow, P propertiesPopulator);
}
