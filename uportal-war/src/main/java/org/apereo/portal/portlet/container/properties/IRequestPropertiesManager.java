...
public interface IRequestPropertiesManager {
     ...
     * javax.portlet.PortletResponse#setProperty(String, String)}. This method should follow the
     * same rules as the PortletResponse method and overwrite any existing property of the same
     * name.
     *
    ...
    /**
     * Called when a portlet sets a property via {@link
     * javax.portlet.PortletResponse#addProperty(String, String)}. This method should follow the
     * same rules as the PortletResponse method and add the value to any existing property of the
     * same name.
     *
