...
public class PrivatePortletCacheKey implements Serializable, TaggedCacheEntry {
  private static final String SESSION_PORTLET_WINDOW_CACHE_ENTRY_TAG_NAME =
      PrivatePortletCacheKey.class.getName() + ".SESSION_ID__PORTLET_WINDOW_ID";
  ...
  PrivatePortletCacheKey(
      String sessionId,
      IPortletWindowId portletWindowId,
      IPortletEntityId portletEntityId,
      PublicPortletCacheKey publicPortletCacheKey) {
  ...
  private int internalHashCode() {
    ...
    result =
        prime * result + ((publicPortletCacheKey == null) ? 0 : publicPortletCacheKey.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!portletEntityId.equals(other.portletEntityId)) return false;
    if (portletWindowId == null) {
      if (other.portletWindowId != null) return false;
    } else if (!portletWindowId.equals(other.portletWindowId)) return false;
    if (publicPortletCacheKey == null) {
      if (other.publicPortletCacheKey != null) return false;
    } else if (!publicPortletCacheKey.equals(other.publicPortletCacheKey)) return false;
    if (sessionId == null) {
  ...
  public String toString() {
    if (this.publicPortletCacheKey.isRenderHeader()) {
      return "PrivatePortletRenderHeaderCacheKey [sessionId="
          + sessionId
          + ", portletWindowId="
          + portletWindowId
          + ", portletEntityId="
          + portletEntityId
          + ", "
          + publicPortletCacheKey
          + "]";
    }
    if (this.publicPortletCacheKey.getResourceId() != null) {
      return "PrivatePortletResourceCacheKey [sessionId="
          + sessionId
          + ", portletWindowId="
          + portletWindowId
          + ", portletEntityId="
    ...
    return "PrivatePortletRenderCacheKey [sessionId="
        + sessionId
        + ", portletWindowId="
        + portletWindowId
        + ", portletEntityId="
