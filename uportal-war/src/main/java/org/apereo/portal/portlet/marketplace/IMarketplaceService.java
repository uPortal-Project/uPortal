...
public interface IMarketplaceService {
  ...
  /**
   * Return the Marketplace entries visible to the user. Marketplace entries are visible to the user
   * when the user enjoys permission for the UP_PORTLET_SUBSCRIBE.BROWSE or
   ...
   * implying BROWSE) permission on at least one portlet in that category. (That is, the category is
   * not "empty" from the perspective of this user browsing).
   *
   ...
   * @param portletDefinition A non-null portlet definition the Marketplace entry of which the user
   *     might browse
