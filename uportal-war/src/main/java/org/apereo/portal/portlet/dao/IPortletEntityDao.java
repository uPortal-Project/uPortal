...
public interface IPortletEntityDao {
   ...
   * @throws org.springframework.dao.DataIntegrityViolationException If an entity already exists for
   *     the layout node id and userId pair
   ...
   * @return A set of all entities based on the specified portlet definition id, will be empty if no
   *     entities exist for the id, will never be null.
   ...
   * @return A set of all entities base on the specified user id, will be empty if no entities exist
   *     for the id, will never be null.
   */
