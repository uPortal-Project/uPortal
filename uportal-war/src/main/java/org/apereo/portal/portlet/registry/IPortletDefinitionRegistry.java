...
public interface IPortletDefinitionRegistry {
   ...
   * @return The parent portlet descriptor for the definition, null if no definition exists for the
   *     id.
   * @throws IllegalArgumentException if portletDefinitionId is null
   * @throws DataRetrievalFailureException if the {@link PortletDefinition} cannot be found for the
