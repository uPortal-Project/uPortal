...
public interface IPortletSpELService {
  ...
  /**
   * Parse the supplied string by replacing any ${ } blocks with the SpEL-evaluated value, returning
  ...
  /**
   * Returns a SpEL Expression using the standard Parsing Context (uses ${ }). Allows you to supply
   * your own {@link org.springframework.expression.spel.support.StandardEvaluationContext} to
   * evaluate the expression against any objects you want. Refer to SpEL API or review the code in
