...
public class PortletWorkerFactoryImpl implements IPortletWorkerFactory {
    ...
    /* (non-Javadoc)
     * @see org.apereo.portal.portlet.rendering.worker.IPortletWorkerFactory#getActionWorker()
     */
    @Override
    public IPortletActionExecutionWorker createActionWorker(
            HttpServletRequest request,
            HttpServletResponse response,
            IPortletWindowId portletWindowId) {
        final IPortletWindow portletWindow =
                this.portletWindowRegistry.getPortletWindow(request, portletWindowId);
        return new PortletActionExecutionWorker(
                portletThreadPool,
    ...
    @Override
    public IPortletEventExecutionWorker createEventWorker(
            HttpServletRequest request,
            HttpServletResponse response,
            IPortletWindowId portletWindowId,
            Event event) {
        final IPortletWindow portletWindow =
                this.portletWindowRegistry.getPortletWindow(request, portletWindowId);
        return new PortletEventExecutionWorker(
                portletThreadPool,
                executionInterceptors,
                portletRenderer,
                request,
    ...
    public IPortletRenderExecutionWorker createRenderHeaderWorker(
        ...
        final IPortletWindow portletWindow =
                this.portletWindowRegistry.getPortletWindow(request, portletWindowId);
        return new PortletRenderHeaderExecutionWorker(
                portletThreadPool,
                executionInterceptors,
                portletRenderer,
                request,
    ...
    @Override
    public IPortletRenderExecutionWorker createRenderWorker(
            HttpServletRequest request,
            HttpServletResponse response,
            IPortletWindowId portletWindowId) {
        final IPortletWindow portletWindow =
        ...
        if (portletWindow == null) {
            throw new RuntimeException(
                    "Failed to retrieve the specified PortletWindow:  " + portletWindowId);
        }
        return new PortletRenderExecutionWorker(
                portletThreadPool,
                executionInterceptors,
                portletRenderer,
                request,
    ...
    @Override
    public IPortletResourceExecutionWorker createResourceWorker(
            HttpServletRequest request,
            HttpServletResponse response,
            IPortletWindowId portletWindowId) {
        final IPortletWindow portletWindow =
                this.portletWindowRegistry.getPortletWindow(request, portletWindowId);
        return new PortletResourceExecutionWorker(
                portletThreadPool,
                executionInterceptors,
                portletRenderer,
                request,
    ...
    @Override
    public IPortletFailureExecutionWorker createFailureWorker(
            HttpServletRequest request,
            HttpServletResponse response,
            IPortletWindowId failedPortletWindowId,
            Exception cause) {
        final IPortletWindowId errorPortletWindowId =
                this.getErrorPortletWindowId(request, this.errorPortletFName);
        return new PortletFailureExecutionWorker(
                portletRenderer,
                executionInterceptors,
                request,
                response,
