...
public interface IPortletEntityRegistry {
  ...
  /**
   * Get an existing portlet entity for the String version of the entity id. If an exception occurs
   * while parsing the String into an {@link IPortletEntityId} an {@link IllegalArgumentException}
   * will be thrown. If no entity exists for the id null will be returned.
   *
   ...
   * preferred channel subscribe id. If the specified subscribe ID can be found in the user's layout
   * it is used, if not the functionality provided by {@link
  ...
  /**
   * Gets or Creates a delegate portlet entity based on the portlet definition and for delegation to
