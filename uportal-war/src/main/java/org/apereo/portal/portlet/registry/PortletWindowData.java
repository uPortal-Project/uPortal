...
class PortletWindowData implements IPortletWindowDescriptor, Serializable {
  ...
  private transient volatile PortletMode portletMode = PortletMode.VIEW;
  private transient volatile WindowState windowState = WindowState.NORMAL;
  ...
  public int hashCode() {
    ...
    result =
        prime * result
            + ((this.delegationParentId == null) ? 0 : this.delegationParentId.hashCode());
    result =
        prime * result + ((this.portletEntityId == null) ? 0 : this.portletEntityId.hashCode());
    result =
        prime * result + ((this.portletWindowId == null) ? 0 : this.portletWindowId.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (this.delegationParentId == null) {
      if (other.delegationParentId != null) return false;
    } else if (!this.delegationParentId.equals(other.delegationParentId)) return false;
