...
public class LocalCCPPProfileServiceImpl implements CCPPProfileService {
  ...
  /**
   * Returns null if no CCPP implementation is available. If a CCPP implementation is available, may
   * return null if no {@link Profile} can be identified from the request.
   *
   * @see
