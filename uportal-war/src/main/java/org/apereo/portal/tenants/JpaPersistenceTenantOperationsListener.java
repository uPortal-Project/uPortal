...
public final class JpaPersistenceTenantOperationsListener extends AbstractTenantOperationsListener {
  ...
  public TenantOperationResponse onCreate(final ITenant tenant) {
    try {
      ...
      error.addMessage(
          createLocalizedMessage(FAILED_TO_CREATE_TENANT, new String[] {tenant.getName()}));
      return error;
    }
    final TenantOperationResponse rslt =
        new TenantOperationResponse(this, TenantOperationResponse.Result.SUCCESS);
    rslt.addMessage(
        createLocalizedMessage(TENANT_CREATED_SUCCESSFULLY, new String[] {tenant.getName()}));
    return rslt;
  }
  ...
  public TenantOperationResponse onUpdate(final ITenant tenant) {
    try {
      ...
      final TenantOperationResponse error =
          new TenantOperationResponse(this, TenantOperationResponse.Result.ABORT);
      error.addMessage(
          createLocalizedMessage(FAILED_TO_UPDATE_TENANT, new String[] {tenant.getName()}));
      return error;
    }
    final TenantOperationResponse rslt =
        new TenantOperationResponse(this, TenantOperationResponse.Result.SUCCESS);
  ...
  public TenantOperationResponse onDelete(final ITenant tenant) {
    try {
      ...
      final TenantOperationResponse error =
          new TenantOperationResponse(this, TenantOperationResponse.Result.ABORT);
      error.addMessage(
          createLocalizedMessage(FAILED_TO_DELETE_TENANT, new String[] {tenant.getName()}));
      return error;
    }
    final TenantOperationResponse rslt =
        new TenantOperationResponse(this, TenantOperationResponse.Result.SUCCESS);
    rslt.addMessage(
        createLocalizedMessage(TENANT_DELETED_SUCCESSFULLY, new String[] {tenant.getName()}));
    return rslt;
  }
}
