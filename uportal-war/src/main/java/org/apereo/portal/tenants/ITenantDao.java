...
/* package-private */ interface ITenantDao {
    ...
    /** Obtains the complete set of {@link ITenant} objects contained within this data source. */
    ...
    /**
     * Returns a new, empty {@link ITenant} instance of the runtime type supported by this
     * ITenantDao implementation.
     *
     * @param fname The unique identifier for a tenant
     * @return The tenant with the corresponding fname, or <code>null</code>
     */
