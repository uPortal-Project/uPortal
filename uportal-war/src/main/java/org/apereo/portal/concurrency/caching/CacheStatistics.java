...
public final class CacheStatistics implements CacheStatisticsMBean {
   ...
   * This is always incremented in conjunction with {@link #missCount}, though {@code missCount} is
   ...
   * value. This is always incremented in conjunction with {@code missCount}, though {@code
  ...
  /**
   * Returns the total number of nanoseconds the cache has spent loading values from cache. This can
   * be used to calculate the miss penalty. This value is increased every time {@code hitCount} is
   * incremented.
   */
  @Override
  ...
  /**
   * Returns the average time spent loading new values. This is defined as {@code totalExceptionTime
   * / loadExceptionCount}.
   */
  @Override
