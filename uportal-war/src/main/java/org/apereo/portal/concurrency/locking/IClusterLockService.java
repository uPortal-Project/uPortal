...
public interface IClusterLockService {
    ...
    enum LockStatus {
        ...
        EXECUTED,
        /**
         * {@link LockOptions#getLastRunDelay()} was greater than 0 and the lock was last held less
         * than that many milliseconds ago
         */
        SKIPPED_LAST_RUN,
        /**
         * {@link LockOptions#getServerBiasDelay()} was greater than 0 and the lock was last held by
         * a different server less than that many milliseconds ago
         */
        SKIPPED_SERVER_BIAS,
    ...
    <T> TryLockFunctionResult<T> doInTryLock(
            String mutexName, Function<ClusterMutex, T> lockFunction) throws InterruptedException;
     ...
     * @param lockFunction The fuction to call within the lock context, the parameter to the
     *     function is the locked {@link ClusterMutex}
