...
public class LoadedResourceImpl<T> implements LoadedResource<T> {
  ...
  public LoadedResourceImpl(T resource, Map<Resource, Long> additionalSources) {
    ...
    if (additionalSources == null) {
      ...
      this.additionalSources =
          Collections.unmodifiableMap(new LinkedHashMap<Resource, Long>(additionalSources));
    }
  }
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
        prime * result + ((this.additionalSources == null) ? 0 : this.additionalSources.hashCode());
