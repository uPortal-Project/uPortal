...
public class PortletHttpServletResponseWrapper extends AbstractHttpServletResponseWrapper {
  ...
  public void setBufferSize(int size) {
    this.logger.warn(
        "Ignoring call to HttpServletResponse.setBufferSize({}) from {}", size, portletWindow);
  }

  @Override
  public void setContentType(String type) {
    this.logger.warn(
        "Ignoring call to HttpServletResponse.setContentType({}) from {}", type, portletWindow);
  }
  ...
  public void addCookie(Cookie cookie) {
    this.logger.warn(
        "Ignoring call to HttpServletResponse.addCookie({}) from {}", cookie, portletWindow);
  }
  ...
  public void sendRedirect(String location) throws IOException {
    this.logger.warn(
        "Ignoring call to HttpServletResponse.sendRedirect({}) from {}", location, portletWindow);
  }
  ...
  public void setContentLength(int len) {
    this.logger.warn(
        "Ignoring call to HttpServletResponse.setContentLength({}) from {}", len, portletWindow);
  }
