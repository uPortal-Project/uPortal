...
public class VersionUtils {
  ...
  /**
   * Determine if an "update" can be done between the from and to versions. The ability to update is
   * defined as from == to OR (from.isBefore(to) AND mostSpecificMatchingField in (PATCH, MINOR))
   *
