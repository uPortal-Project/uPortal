...
public class UserImpersonationTransformerConfigurationSource
    ...
    public CacheKey getCacheKey(HttpServletRequest request, HttpServletResponse response) {
        ...
        return CacheKey.build(
                UserImpersonationTransformerConfigurationSource.class.getName(),
                userImpersonatingParameter,
                impersonating);
    }
    ...
    public Map<String, Object> getParameters(
        ...
        final Map<String, Object> parameters =
                Collections.<String, Object>singletonMap(userImpersonatingParameter, impersonating);
