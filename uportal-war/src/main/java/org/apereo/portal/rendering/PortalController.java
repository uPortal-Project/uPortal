  ...
  public void renderExclusive(HttpServletRequest request, HttpServletResponse response) {
    ...
    if (portletRequestInfo == null) {
      throw new IllegalArgumentException(
          "A portlet must be targeted when using the EXCLUSIVE WindowState: " + portalRequestInfo);
    }
  ...
  public void actionRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    if (portletRequestInfo != null) {
      ...
      try {
        ...
        this.logger.error(
            "Exception thrown while executing portlet action for: " + portletRequestInfo, e);
