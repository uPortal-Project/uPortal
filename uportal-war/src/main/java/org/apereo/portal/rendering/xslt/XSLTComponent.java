  ...
  public PipelineEventReader<XMLEventReader, XMLEvent> getEventReader(
    ...
    if (this.xsltParameterSource != null) {
      ...
      if (transformerParameters != null) {
        this.logger.debug(
            "{} - Setting Transformer Parameters: ", this.beanName, transformerParameters);
      ...
      if (outputProperties != null) {
        this.logger.debug(
            "{} - Setting Transformer Output Properties: ", this.beanName, outputProperties);
    ...
    final PipelineEventReaderImpl<XMLEventReader, XMLEvent> pipelineEventReaderImpl =
        new PipelineEventReaderImpl<XMLEventReader, XMLEvent>(outputEventReader, outputProperties);
