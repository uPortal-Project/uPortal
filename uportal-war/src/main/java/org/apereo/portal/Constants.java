...
public class Constants {
   ...
   * fname of a channel, to cause an instance of that channel to appear in focused mode without the
   * user having to subcribe to that channel. Examples are infrastructure channels like
   ...
   * remainder of a user's session. The value of this parameter should be a comma-delimited list of
   * locale codes. For example, en_US,ja_JP,de_DE
   */
   ...
   * passing a functional name. The value of this field can be passed to that method to obtain a URL
   * that will bring that channel into focus.
   */
