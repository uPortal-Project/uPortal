...
public class ExternalRedirectionUrl extends AbstractRedirectionUrl {
    ...
    /**
     * String representation of an absolute URL. This url cannot be relative and should not include
     * any parameters in the string.
     *
     * @return
     */
    ...
    /**
     * Sets the string representation of an absolute URL. This url cannot be relative and should not
