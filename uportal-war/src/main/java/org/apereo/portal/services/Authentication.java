...
public class Authentication {
      ...
      if (addInfo != null) {
        ...
        // simply copy all of these additional attributes into the IPerson
          ...
          if (log.isWarnEnabled()) {
            log.warn(
                "Authentication Service received unknown additional descriptor [" + addInfo + "]");
          }
        }
      }
  ...
  /**
   * Recurse through the {@link ISecurityContext} chain, setting the credentials for each. TODO This
   * functionality should be moved into the {@link
