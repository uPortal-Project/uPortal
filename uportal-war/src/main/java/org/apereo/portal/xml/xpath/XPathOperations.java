...
public interface XPathOperations {
  /**
   * Call the specified Function with the compiled {@link XPathExpression} version of the expression
   * string
   */
  ...
  /**
   * Call the specified Function with the compiled {@link XPathExpression} version of the expression
   * string The provided variables will be available for the expression at evaluation time
   */
