...
public class DynamicRespondrSkinViewController {
   ...
   * RELATIVE_ROOT/{defaultSkin}.css dynamic=true: Process the default skin less file if needed at
   * RELATIVE_ROOT/{defaultSkin}.less to create a customized skin css file
  ...
  /**
   * Calculate the default skin URL path or the path to a skin CSS file that is specific to the set
   * of portlet preference values currently defined.
   *
   * @param request
   * @return
   * @throws IOException
