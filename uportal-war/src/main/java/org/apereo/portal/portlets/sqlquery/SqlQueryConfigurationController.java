...
public class SqlQueryConfigurationController {
  ...
  public void saveConfiguration(
    ...
    if (StringUtils.isNotBlank(save)) {
      ...
      prefs.setValue(
          SqlQueryPortletController.DATASOURCE_BEAN_NAME_PARAM_NAME, form.getDataSource());
  ...
  public SqlQueryConfigForm getConfigurationForm(PortletRequest request) {
    ...
    form.setDataSource(
        prefs.getValue(
            SqlQueryPortletController.DATASOURCE_BEAN_NAME_PARAM_NAME, defaultDataSource));
    ...
    form.setCacheName(
        prefs.getValue(
            SqlQueryPortletController.PREF_CACHE_NAME,
            SqlQueryPortletController.DEFAULT_CACHE_NAME));
