...
import org.apereo.portal.events.aggr.portletexec.PortletExecutionAggregationDao;
import org.apereo.portal.events.aggr.portletexec.PortletExecutionAggregationDiscriminator;
...
import org.apereo.portal.events.aggr.portlets.AggregatedPortletMappingNameComparator;
import org.apereo.portal.portlets.statistics.ReportTitleAndColumnDescriptionStrategy.TitleAndCount;
...
public class PortletExecutionStatisticsController
  ...
  public ModelAndView renderPortletExecutionAggregationReport(PortletExecutionReportForm form)
  ...
  public Set<AggregatedPortletMapping> getPortlets() {
    final Set<AggregatedPortletMapping> groupMappings =
        aggregatedPortletLookupDao.getPortletMappings();

    final Set<AggregatedPortletMapping> sortedGroupMappings =
        new TreeSet<AggregatedPortletMapping>(AggregatedPortletMappingNameComparator.INSTANCE);
  ...
  @Override
  protected BaseAggregationDao<PortletExecutionAggregation, PortletExecutionAggregationKey>
  ...
  @Override
  protected Comparator<? super PortletExecutionAggregationDiscriminator>
  ...
  protected List<Value> createRowValues(
      PortletExecutionAggregation aggr, PortletExecutionReportForm form) {
