...
public class PreferenceInputFactory {
  ...
  /**
   * Define a single-valued text input preferences. This method is a convenient wrapper for the most
   * common expected use case and assumes null values for the default value and a predictable label.
   *
   * @param name
   * @param label
   * @return
   ...
   * @return
   */
  public static Preference createSingleTextPreference(
    ...
    pref.setPreferenceInput(
        new JAXBElement<SingleTextPreferenceInput>(
            new QName("single-text-parameter-input"), SingleTextPreferenceInput.class, input));
  ...
  public static Preference createSingleChoicePreference(
    ...
    pref.setPreferenceInput(
        new JAXBElement<SingleChoicePreferenceInput>(
            new QName("single-choice-parameter-input"), SingleChoicePreferenceInput.class, input));
  ...
  public static Preference createMultiTextPreference(
    ...
    pref.setPreferenceInput(
        new JAXBElement<MultiTextPreferenceInput>(
            new QName("multi-text-parameter-input"), MultiTextPreferenceInput.class, input));
   ...
   * @return
   */
  public static Preference createMultiChoicePreference(
      String name,
      String label,
    ...
    pref.setPreferenceInput(
        new JAXBElement<MultiChoicePreferenceInput>(
            new QName("multi-choice-parameter-input"), MultiChoicePreferenceInput.class, input));
