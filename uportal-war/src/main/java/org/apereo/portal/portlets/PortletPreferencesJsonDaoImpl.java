...
public class PortletPreferencesJsonDaoImpl implements PortletPreferencesJsonDao {
  ...
  /**
   * Read the specified portlet preference and parse it as a JSON string into the specified type. If
   * the preference is null returns null.
   *
  ...
  /**
   * Read the specified portlet preference and parse it as a JSON string into a {@link JsonNode} If
   * the preference is null returns a {@link JSONObject}.
   *
   * @param prefs Preferences to read from
   * @param key Preference key to read from
   */
