...
public interface DynamicSkinService {
     ...
     * be created simultaneously to handle large tenant situations where all the custom CSS files
     ...
     * @param lessfileBaseName base name of the less file; e.g. a value of foo will compile
     *     foo.less.
     */
