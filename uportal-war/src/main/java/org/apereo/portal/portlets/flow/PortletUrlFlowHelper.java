...
public class PortletUrlFlowHelper {
    public void setWindowState(ExternalContext externalContext, String windowState) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "setWindowState can only be called during an action request", e);
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "The specified WindowState '" + windowState + "' is not valid", e);
        }
    }
    ...
    public void setPortletMode(ExternalContext externalContext, String portletMode) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "setPortletMode can only be called during an action request", e);
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "The specified PortletMode '" + portletMode + "' is not valid", e);
        }
    }
}
