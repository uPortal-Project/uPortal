...
public class UserLocaleHelper {
  ...
  /**
   * Update the current user's locale to match the selected locale. This implementation will update
   * the session locale, and if the user is not a guest, will also update the locale in the user's
