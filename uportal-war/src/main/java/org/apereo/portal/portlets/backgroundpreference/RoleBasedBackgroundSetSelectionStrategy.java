...
public class RoleBasedBackgroundSetSelectionStrategy implements BackgroundSetSelectionStrategy {
  ...
  private enum PreferenceNames {
    ...
    /**
     * The portlet-preference containing the image captions. This preference name will not change.
     */
  ...
  /**
   * Allows us to evaluate '${portalContext}' to '/uPortal' (or whatever it is) within image paths.
   */
