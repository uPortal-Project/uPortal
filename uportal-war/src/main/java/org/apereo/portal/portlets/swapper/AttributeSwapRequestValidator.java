...
public class AttributeSwapRequestValidator {
  ...
  /**
   * {@link IAttributeSwapperHelper} to use for getting configuration and query information from for
   * validation.
   */
  ...
  public void validateAttributesForm(
  ...
  /**
   * Checks the keys in the Map on the model against a Set to ensure there are no values in the Map
   * that aren't also in the Set
   */
