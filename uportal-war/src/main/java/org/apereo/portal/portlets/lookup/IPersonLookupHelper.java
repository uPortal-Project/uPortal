...
public interface IPersonLookupHelper {
  ...
  /**
   * Portlet preference name to use to specify a list of attributes who's values should be passed to
   * the MessageFormat for the resultsMessage string
   */
   ...
   * user. Both the returned person list and the attributes of the returned people will be filtered
   * according to the searching user's permissions.
   *
   * @param searcher
   * @param query
   * @return
  ...
  /**
   * Find an individual person matching the provided username. The returned result (if any), will be
   * limited by the permissions of the searching user.
   *
   * @param searcher
   * @param username
   * @return
