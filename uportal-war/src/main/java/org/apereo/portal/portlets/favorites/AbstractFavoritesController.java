...
public abstract class AbstractFavoritesController {
   ...
   *
   * <p>When set to null, signals Favorites portlet to suppress links to Marketplace. Setting to the
   * empty String or to the literal value "null" (ignoring case) is equivalent to setting to null.
   *
   * <p>This is for convenience in expressing no-marketplace-fname-available via injected value from
