...
public class PortletErrorController {
  ...
  public String renderError(RenderRequest request, RenderResponse response, ModelMap model)
    ...
    if (hasAdminPrivileges(userInstance)) {
      IPortletWindow window =
          this.portletWindowRegistry.getPortletWindow(httpRequest, currentFailedPortletWindowId);
      ...
      final IPortletWindow portletWindow =
          portletWindowRegistry.getPortletWindow(httpRequest, currentFailedPortletWindowId);
  ...
  /**
   * @return true if the userInstance argument has administrative privileges regarding viewing error
   *     details
   */
