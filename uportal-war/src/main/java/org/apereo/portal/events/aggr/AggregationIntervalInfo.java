...
public class AggregationIntervalInfo implements Serializable {
  ...
  /**
   * @return The date dimension that corresponds with the {@link #getStart()} value, null if no date
   *     dimension exists yet for the start {@link DateTime}
   */
  public DateDimension getDateDimension() {
    return dateDimension;
  }
  /**
   * @return The time dimension that corresponds with the {@link #getStart()} value, null if no time
   *     dimension exists yet for the start {@link DateTime}
   */
