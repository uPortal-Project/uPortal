...
public final class LoginAggregationKeyImpl extends BaseAggregationKeyImpl
        implements LoginAggregationKey {
    private static final long serialVersionUID = 1L;

    public LoginAggregationKeyImpl(
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LoginAggregationKey)) return false;
        return super.equals(obj);
    }

    @Override
    public String toString() {
        return "LoginAggregationKey [dateDimension="
                + getDateDimension()
                + ", timeDimension="
                + getTimeDimension()
                + ", interval="
