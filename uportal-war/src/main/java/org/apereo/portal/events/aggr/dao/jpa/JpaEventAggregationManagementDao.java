...
public class JpaEventAggregationManagementDao extends BaseAggrEventsJpaDao
  ...
  public void afterPropertiesSet() throws Exception {
        ...
        this.createCriteriaQuery(
            new Function<CriteriaBuilder, CriteriaQuery<AggregatedGroupConfigImpl>>() {
              ...
              public CriteriaQuery<AggregatedGroupConfigImpl> apply(CriteriaBuilder cb) {
                ...
                criteriaQuery.where(
                    cb.equal(
                        entityRoot.get(AggregatedGroupConfigImpl_.aggregatorType),
    ...
    this.findAllIntervalConfigsQuery =
        this.createCriteriaQuery(
            new Function<CriteriaBuilder, CriteriaQuery<AggregatedIntervalConfigImpl>>() {
              @Override
        ...
        this.createCriteriaQuery(
            new Function<CriteriaBuilder, CriteriaQuery<AggregatedIntervalConfigImpl>>() {
              ...
              public CriteriaQuery<AggregatedIntervalConfigImpl> apply(CriteriaBuilder cb) {
                ...
                criteriaQuery.where(
                    cb.equal(
                        entityRoot.get(AggregatedIntervalConfigImpl_.aggregatorType),
                        aggregatorTypeParameter));
