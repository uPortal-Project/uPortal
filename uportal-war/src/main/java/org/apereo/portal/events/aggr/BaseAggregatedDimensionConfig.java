...
public interface BaseAggregatedDimensionConfig<D> extends Serializable {
  ...
  /**
   * If no dimensions are included or excluded false will be returned. If at least one dimension is
   * in the {@link #getIncluded()} or {@link #getExcluded()} sets then {@link
