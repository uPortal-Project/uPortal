        ...
        this.createCriteriaQuery(
            new Function<CriteriaBuilder, CriteriaQuery<DateTime>>() {
              ...
              public CriteriaQuery<DateTime> apply(CriteriaBuilder cb) {
                ...
                criteriaQuery.select(cb.greatest(eventRoot.get(PersistentPortalEvent_.timestamp)));
        ...
        this.createCriteriaQuery(
            new Function<CriteriaBuilder, CriteriaQuery<DateTime>>() {
              ...
              public CriteriaQuery<DateTime> apply(CriteriaBuilder cb) {
                ...
                criteriaQuery.select(cb.least(eventRoot.get(PersistentPortalEvent_.timestamp)));
  ...
  public boolean aggregatePortalEvents(
    ...
    for (final ScrollableResults results = query.scroll(ScrollMode.FORWARD_ONLY);
      ...
      try {
        ...
        this.logger.warn(
            "Failed to convert PersistentPortalEvent to PortalEvent: " + persistentPortalEvent, e);
