...
public class JpaStatisticalSummary implements TimedAggregationStatistics {
  ...
  /**
   * Returns a statistic related to the Second Central Moment. Specifically, what is returned is the
   * sum of squared deviations from the sample mean among the values that have been added.
   *
   * <p>Returns <code>Double.NaN</code> if no data values have been added and returns <code>0</code>
