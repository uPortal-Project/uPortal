                ...
                criteriaQuery.where(
                    cb.and(
                        cb.greaterThanOrEqualTo(
                            dimensionRoot.get(DateDimensionImpl_.date), dateTimeParameter),
                        cb.lessThan(
                            dimensionRoot.get(DateDimensionImpl_.date), endDateTimeParameter)));
                criteriaQuery.orderBy(cb.asc(dimensionRoot.get(DateDimensionImpl_.date)));
        ...
        this.createCriteriaQuery(
            new Function<CriteriaBuilder, CriteriaQuery<DateDimensionImpl>>() {
              ...
              public CriteriaQuery<DateDimensionImpl> apply(CriteriaBuilder cb) {
                ...
                final Root<DateDimensionImpl> maxDateDimensionSub =
                    maxDateSub.from(DateDimensionImpl.class);
                maxDateSub.select(cb.least(maxDateDimensionSub.get(DateDimensionImpl_.date)));
