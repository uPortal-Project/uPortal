...
public class JpaTabRenderAggregationDao
  ...
  protected void addUnclosedPredicate(
      CriteriaBuilder cb, Root<TabRenderAggregationImpl> root, List<Predicate> keyPredicates) {
  ...
  protected void bindAggregationSpecificKeyParameters(
    ...
    query.using(
        TabRenderAggregationImpl_.aggregatedTab, (AggregatedTabMappingImpl) key.getTabMapping());
  }
