...
public final class ConcurrentUserAggregationDiscriminatorImpl
    ...
    public ConcurrentUserAggregationDiscriminatorImpl(
            ConcurrentUserAggregation concurrentUserAggregation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ConcurrentUserAggregationDiscriminator)) return false;
        return super.equals(obj);
    }

    // Compare discriminators based on the group name
    public static class Comparator
            extends ComparableExtractingComparator<ConcurrentUserAggregationDiscriminator, String> {
