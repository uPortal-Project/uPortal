...
public abstract class UserLayoutNodeDescription implements IUserLayoutNodeDescription {
  ...
  /**
   * Returns the precedence value for this node. The precedence is 0.0 for a user owned node and the
   * value of the node's owning fragment's precedence for a node incorporated from another fragment.
