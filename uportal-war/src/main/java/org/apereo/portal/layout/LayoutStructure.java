...
public final class LayoutStructure {
   ...
   * return an empty list when there are no parameters. This simplifies consumers of this class, who
   * can simply blithely iterate over the empty list and no longer have to check for null.
   *
   ...
   * in the up_layout_struct table's type column. For instances of LayoutStructure that represent a
   * channel this method will return a value of null.
   *
