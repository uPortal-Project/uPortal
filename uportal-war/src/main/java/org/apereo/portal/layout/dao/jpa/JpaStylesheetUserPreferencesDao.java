...
public class JpaStylesheetUserPreferencesDao extends BasePortalJpaDao
  ...
  public void afterPropertiesSet() throws Exception {
    this.stylesheetDescriptorParameter =
        this.createParameterExpression(StylesheetDescriptorImpl.class, "stylesheetDescriptor");
    ...
    this.findAllPreferences =
        this.createCriteriaQuery(
            new Function<CriteriaBuilder, CriteriaQuery<StylesheetUserPreferencesImpl>>() {
              @Override
            ...
            new Function<CriteriaBuilder, CriteriaQuery<StylesheetUserPreferencesImpl>>() {
              ...
              public CriteriaQuery<StylesheetUserPreferencesImpl> apply(CriteriaBuilder cb) {
                ...
                criteriaQuery.where(
                    cb.and(
                        cb.equal(
                            descriptorRoot.get(StylesheetUserPreferencesImpl_.userId),
                            userIdParameter),
                        cb.equal(
                            descriptorRoot.get(StylesheetUserPreferencesImpl_.stylesheetDescriptor),
                            stylesheetDescriptorParameter),
                        cb.equal(
                            descriptorRoot.get(StylesheetUserPreferencesImpl_.profileId),
                            profileIdParameter)));
  ...
  public IStylesheetUserPreferences getStylesheetUserPreferences(
    ...
    query.setParameter(
        this.stylesheetDescriptorParameter, (StylesheetDescriptorImpl) stylesheetDescriptor);
    query.setParameter(this.userIdParameter, personId);
