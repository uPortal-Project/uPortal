...
public interface IGroupListHelper {
  ...
  /**
   * Obtain the user's best root (starting) entity available given the specified permissions
   * activity.
   */
  JsonEntityBean getIndividualBestRootEntity(
      IPerson person, String groupType, String permissionOwner, String permissionActivity);
   ...
   */
  JsonEntityBean getIndividualBestRootEntity(
      IPerson person, String groupType, String permissionOwner, String[] permissionActivities);

  /**
   * Get the set of entity types allowed as children of the specified group type.
   *
   * @param groupType
   * @return
   */
  ...
  /**
   * Retrieve an individual entity matching the specified type and id. If populateChildren is set to
   * <code>true</code> populate the entity bean with the entity's children before returning it. This
   * argument will be ignored entirely if the entity is not of a group type, since non-group
  ...
  /**
   * Get a list of JsonEntityBeans for a supplied list of string identifiers, where an identifier
   * consists of a colon-separated pairing of entity type and entity ID. For example, a Person Group
   * entity with they key local.0 would be indicated by the identifier string "group:local.0".
   *
