...
public interface IUserLayoutFolderDescription extends IUserLayoutNodeDescription {
  ...
  /**
   * Type attribute value of folders representing a named collection of user favorites (used by the
   * optional Favorites portlet).
   *
   * @since uPortal 4.1
   */
  ...
  /**
   * Returns folder type. Type might be one of the values documented in this interface. Then again,
   * it might be any other String.
   *
   * @since uPortal 4.1
