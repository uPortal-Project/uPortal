...
public class FragmentActivator
{
    ...
    private static final String PROPERTY_ALLOW_EXPANDED_CONTENT = "org.apereo.portal.layout.dlm.allowExpandedContent";
    ...
    @Autowired
    public void setUserViewErrors(@Qualifier("org.apereo.portal.layout.dlm.FragmentActivator.userViewErrors") Ehcache userViewErrors) {
    ...
    private int createOwner( IPerson owner, FragmentDefinition fragment )
    {
        ...
        if ( fragment.defaultLayoutOwnerID != null ) {
            ...
            final String defaultLayoutOwner = PropertiesManager.getProperty("org.apereo.portal.layout.dlm.defaultLayoutOwner");
