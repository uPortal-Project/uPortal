...
public class ServerProfileMapperImpl implements IProfileMapper {
   ...
   * setDefaultProfile} is not called if the user is using a server in the server regular expression
   * specified by {@link #setServerRegex(String serverRegex) setServerRegex} returns null otherwise
   *
