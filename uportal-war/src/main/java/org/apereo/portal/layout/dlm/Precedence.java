...
public final class Precedence {
  ...
  /**
   * Returns true of this complete precedence is less than the complete precedence of the passed in
   * Precedence object. The complete precedence takes into account the location in the configuration
   * file of the fragment definition. If the "precedence" value is equal then the precedence object
   * with the lowest index has the higher complete precedence. And index of -1 indicates the highest
   * index in the file.
   */
