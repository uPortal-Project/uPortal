...
public interface IUserLayoutManager {
   ...
   *     have to be set)
   * @param parentId a <code>String</code> id of a folder to which the new node (channel or folder)
   *     should be added.
   * @param nextSiblingId a <code>String</code> an id of a sibling node (channel or folder) prior to
   *     which the new node should be inserted.
  ...
  /**
   * Ask manager to output markings at the locations where a given node can be added. The marks will
   * appear next time <code>getUserLayout</code> method is called.
   *
  ...
  /**
   * Ask manager to output markings at the locations where a given node can be moved. The marks will
   * appear next time <code>getUserLayout</code> method is called.
   *
   ...
   *
   * @param nodeId a <code>String</code> value
   * @return a <code>String</code> Id value of a next sibling node, or <code>null</code> if this is
   *     the last sibling.
   * @exception PortalException if an error occurs
   */
   ...
   *
   * @param nodeId a <code>String</code> value
   * @return a <code>String</code> Id value of a previous sibling node, or <code>null</code> if this
  ...
  /**
   * @deprecated {@link #getUserLayout()} should be used instead. Direct manipulation of the DOM can
   *     cause caching problems and issues where the layout manager doesn't know about DOM changes.
   *     Read https://lists.wisc.edu/read/messages?id=2167043 for more information.
   */
  @Deprecated
