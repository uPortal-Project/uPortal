...
public class LPAResetParameter implements ILayoutProcessingAction {
  ...
  LPAResetParameter(String nodeId, String name, String fragmentValue, IPerson p, Element ilfNode) {
    this.nodeId = nodeId;
    this.name = name;
    this.person = p;
  ...
  /**
   * Reset the parameter to not override the value specified by a fragment. This is done by removing
