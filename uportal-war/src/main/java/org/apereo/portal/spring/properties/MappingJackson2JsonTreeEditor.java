...
public class MappingJackson2JsonTreeEditor extends PropertyEditorSupport {
   ...
   * org.codehaus.jackson.map.SerializerFactory} can be configured that provides custom serializers
   * for specific types. The other option for refining the serialization process is to use Jackson's
   * provided annotations on the types to be serialized, in which case a custom-configured
