...
/**
 * PortalAuthentication provides a uPortal-specific implementation of Spring Security's
...
public class PortalAuthentication implements Authentication {
    ...
    public void setAuthenticated(boolean authenticated) throws IllegalArgumentException {
        throw new IllegalArgumentException(
                "PortalAuthentication implementation does not allow manually setting authenticated flag");
    }
}
