...
public class ClassApplicationEventFilter<E extends ApplicationEvent>
  ...
  /**
   * If no <code>ignoredEvents</code> {@link Collection} is configured all {@link ApplicationEvent}
   * sub-classes are supported otherwise matching is done. The property defaults to null (all event
   * types)
   *
   * @param supportedEvents the supportedEvents to set
   */
