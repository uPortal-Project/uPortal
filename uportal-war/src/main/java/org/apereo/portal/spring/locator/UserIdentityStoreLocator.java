 ...
 * @deprecated code that needs an {@link IUserIdentityStore} should use direct dependency injection
 *     where possible
 */
@Deprecated
public class UserIdentityStoreLocator extends AbstractBeanLocator<IUserIdentityStore> {
