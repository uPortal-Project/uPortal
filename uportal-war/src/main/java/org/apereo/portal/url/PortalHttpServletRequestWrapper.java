...
public class PortalHttpServletRequestWrapper extends AbstractHttpServletRequestWrapper {
  ...
  /**
   * Determines whether or not the user is in the given role. The wrapped request is consulted first
   * then the {@link GroupService} is used to determine if a group exists for the specified role and
