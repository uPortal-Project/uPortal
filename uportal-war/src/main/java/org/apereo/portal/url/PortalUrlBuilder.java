...
class PortalUrlBuilder extends AbstractUrlBuilder implements IPortalActionUrlBuilder {
    ...
    private final ConcurrentMap<IPortletWindowId, IPortletUrlBuilder> portletUrlBuilders =
            new ConcurrentHashMap<IPortletWindowId, IPortletUrlBuilder>();
    private String location;
    private String renderUrlParamName;

    public PortalUrlBuilder(
            IUrlSyntaxProvider urlSyntaxProvider,
    ...
    /* (non-Javadoc)
     * @see org.apereo.portal.url.IPortalUrlBuilder#getTargetFolderId()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apereo.portal.url.IPortalUrlBuilder#getTargetPortletWindowId()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apereo.portal.url.IPortalUrlBuilder#getUrlType()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apereo.portal.url.IPortalActionUrlBuilder#setRedirectLocation(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apereo.portal.url.IPortalActionUrlBuilder#setRedirectLocation(java.lang.String, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apereo.portal.url.IPortalActionUrlBuilder#getRedirectLocation()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.apereo.portal.url.IPortalActionUrlBuilder#getRenderUrlParamName()
     */
    @Override
    ...
    public IPortletUrlBuilder getTargetedPortletUrlBuilder() {
        if (this.targetPortletWindowId == null) {
            throw new IllegalStateException(
                    "This url must target a portlet for this call to be valid");
        }
    ...
    /* (non-Javadoc)
     * @see org.apereo.portal.url.IPortalUrlBuilder#getUrlString()
     */
    @Override
    ...
    public String toString() {
        return "PortalUrlBuilder [targetFolderId="
                + this.targetFolderId
                + ", targetPortletWindowId="
                + this.targetPortletWindowId
                + ", urlType="
                + this.urlType
                + ", parameters="
                + this.getParameters()
    ...
    public int hashCode() {
        ...
        result =
                prime * result
                        + ((this.targetFolderId == null) ? 0 : this.targetFolderId.hashCode());
        result =
                prime * result
                        + ((this.targetPortletWindowId == null)
                                ? 0
                                : this.targetPortletWindowId.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (this.targetFolderId == null) {
            if (other.targetFolderId != null) return false;
        } else if (!this.targetFolderId.equals(other.targetFolderId)) return false;
        if (this.targetPortletWindowId == null) {
            if (other.targetPortletWindowId != null) return false;
        } else if (!this.targetPortletWindowId.equals(other.targetPortletWindowId)) return false;
        if (this.urlType != other.urlType) return false;
        return true;
    }
}
