...
class PortletRequestInfoImpl implements IPortletRequestInfo {
  ...
  public PortletRequestInfoImpl(
      IPortletWindowId targetWindowId, IPortalRequestInfo portalRequestInfo) {
  ...
  public String getResourceId() {
    ...
    Preconditions.checkArgument(
        urlType == UrlType.RESOURCE, "UrlType must be %s but was %s", UrlType.RESOURCE, urlType);
    return resourceId;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (this.targetWindowId == null) {
      if (other.targetWindowId != null) return false;
    } else if (!this.targetWindowId.equals(other.targetWindowId)) return false;
    return true;
  }

  @Override
  public String toString() {
    return "PortletRequestInfoImpl [targetWindowId="
        + this.targetWindowId
        + ", portletParameters="
        + this.portletParameters
        + ", windowState="
        + this.windowState
        + ", portletMode="
        + this.portletMode
