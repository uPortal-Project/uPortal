...
public interface IPortletRequestInfo {
   ...
   * @throws IllegalStateException If parent {@link IPortalRequestInfo#getUrlType()} returns {@link
   *     UrlType#RESOURCE}
   */
   ...
   * @throws IllegalStateException If parent {@link IPortalRequestInfo#getUrlType()} does not return
