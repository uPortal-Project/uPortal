...
public class XsltPortalUrlProvider {
    ...
    try {
      ...
      if (StringUtils.isNotEmpty(fname)) {
        final IPortalUrlBuilder portalUrlBuilderByPortletFName =
            this.portalUrlProvider.getPortalUrlBuilderByPortletFName(request, fname, urlType);
      ...
      if (StringUtils.isNotEmpty(layoutId)) {
        final IPortalUrlBuilder portalUrlBuilderByLayoutNode =
            this.portalUrlProvider.getPortalUrlBuilderByLayoutNode(request, layoutId, urlType);
  ...
  public IPortletUrlBuilder getPortletUrlBuilder(
    ...
    return this.getPortletUrlBuilder(
        request, portalUrlBuilder, fname, layoutId, state, mode, copyCurrentRenderParameters, null);
  }
  ...
  public IPortletUrlBuilder getPortletUrlBuilder(
    ...
    if (StringUtils.isNotEmpty(fname)) {
      final IPortletWindow portletWindow =
          this.portletWindowRegistry.getOrCreateDefaultPortletWindowByFname(request, fname);
