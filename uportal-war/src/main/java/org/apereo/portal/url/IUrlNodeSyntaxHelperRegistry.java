...
public interface IUrlNodeSyntaxHelperRegistry {
  ...
  /**
   * Get the {@link IUrlNodeSyntaxHelper} specified by the {@link IStylesheetDescriptor}, returns
   * null if {@link IStylesheetDescriptor#getUrlNodeSyntaxHelperName()} returns null.
   *
  ...
  /**
   * Get the {@link IUrlNodeSyntaxHelper} for the current theme or structure stylesheet descriptor.
   * Never returns null.
   *
   * @throws IllegalArgumentException if no stylesheet descriptor is found for the theme or
   *     structure descriptor
   * @throws IllegalStateException if no IUrlNodeSyntaxHelper is found for the current stylesheet
   *     descriptor(s)
   */
