...
public interface IPortletUrlBuilder extends IUrlBuilder {
   ...
   * @throws IllegalStateException If parent {@link IPortalUrlBuilder#getUrlType()} does not return
  ...
  /**
   * Get the public render parameters set by this portlet. The Map is mutable and making changes to
   * the Map will affect the public render parameters on the URL.
   *
