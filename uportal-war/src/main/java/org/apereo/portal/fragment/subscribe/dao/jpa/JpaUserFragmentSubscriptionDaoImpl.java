...
public class JpaUserFragmentSubscriptionDaoImpl extends BasePortalJpaDao
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    this.findUserFragmentInfoByPersonQuery =
        this.createCriteriaQuery(
            new Function<CriteriaBuilder, CriteriaQuery<UserFragmentSubscriptionImpl>>() {
              @Override
              public CriteriaQuery<UserFragmentSubscriptionImpl> apply(CriteriaBuilder cb) {
                ...
                criteriaQuery.where(
                    cb.equal(root.get(UserFragmentSubscriptionImpl_.userId), userIdParameter));
              ...
              public CriteriaQuery<UserFragmentSubscriptionImpl> apply(CriteriaBuilder cb) {
                ...
                criteriaQuery.where(
                    cb.and(
                        cb.equal(root.get(UserFragmentSubscriptionImpl_.userId), userIdParameter),
                        cb.equal(
                            root.get(UserFragmentSubscriptionImpl_.fragmentOwner),
  ...
  public IUserFragmentSubscription getUserFragmentInfo(long userFragmentInfoId) {
    ...
    final UserFragmentSubscriptionImpl userFragmentInfo =
        this.getEntityManager().find(UserFragmentSubscriptionImpl.class, userFragmentInfoId);
