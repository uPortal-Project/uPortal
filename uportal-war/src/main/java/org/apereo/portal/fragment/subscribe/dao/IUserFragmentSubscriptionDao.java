...
public interface IUserFragmentSubscriptionDao {
   ...
   * @throws org.springframework.dao.DataIntegrityViolationException If a definition already exists
   *     for the specified channelPublishId
   */
   ...
   * @param person the logged in person.
   * @param fragmentOwner the person object representing the fragment owner
   * @return The user fragment subscription for the person and fragment owner, null if no definition
   *     exists for the id.
   */
   ...
   * @return The user fragment subscription for the userFragmentInfoId, null if no definition exists
   *     for the id.
   */
