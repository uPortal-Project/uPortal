...
public final class PagsDefinitionJsonUtils {
  ...
  /**
   * We only want name, description, and a URL that would return the whole object (in JSON) when we
   * serialize the <code>members</code> attribute of a PAGS definition.
   */
