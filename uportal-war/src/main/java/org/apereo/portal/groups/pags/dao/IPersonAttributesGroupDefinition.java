...
public interface IPersonAttributesGroupDefinition {
  ...
  /**
   * Provides the {@link EntityIdentifier} that represents the {@link IEntityGroup} this definition
   * produces in GaP. This identifier will be available -- and identical -- whether the group has
   * been created already or not.
   */
