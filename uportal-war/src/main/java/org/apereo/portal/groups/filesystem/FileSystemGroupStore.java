...
public class FileSystemGroupStore implements IEntityGroupStore, IEntityStore, IEntitySearcher {
   ...
   * that the <code>IEntity</code> belongs to.
   *
  ...
  /**
   * @return org.apereo.portal.groups.IEntityGroup We assume that new groups will be created updated
   *     via the file system, not the group service.
   */
   ...
   * appropriate. We assume that groups will be updated via the file system, not the group service.
   *
   * @param group org.apereo.portal.groups.IEntityGroup
   */
