...
public class JpaPersonAttributesGroupTestDefinitionDao extends BasePortalJpaDao
    implements IPersonAttributesGroupTestDefinitionDao {
  ...
  public IPersonAttributesGroupTestDefinition updatePersonAttributesGroupTestDefinition(
    ...
    Validate.notNull(
        personAttributesGroupTestDefinition, "personAttributesGroupTestDefinition can not be null");
  ...
  public IPersonAttributesGroupTestDefinition createPersonAttributesGroupTestDefinition(
      ...
      String testerClass,
      String testValue) {
    final IPersonAttributesGroupTestDefinition personAttributesGroupTestDefinition =
