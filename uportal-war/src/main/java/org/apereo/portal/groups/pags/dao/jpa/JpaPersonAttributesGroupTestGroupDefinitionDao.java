...
public class JpaPersonAttributesGroupTestGroupDefinitionDao extends BasePortalJpaDao
    ...
    public IPersonAttributesGroupTestGroupDefinition updatePersonAttributesGroupTestGroupDefinition(
        ...
        Validate.notNull(
                personAttributesGroupTestGroupDefinition,
    ...
    @PortalTransactional
    @Override
    public IPersonAttributesGroupTestGroupDefinition createPersonAttributesGroupTestGroupDefinition(
            IPersonAttributesGroupDefinition group) {
        final IPersonAttributesGroupTestGroupDefinition personAttributesGroupTestGroupDefinition =
                new PersonAttributesGroupTestGroupDefinitionImpl(
                        (PersonAttributesGroupDefinitionImpl) group);
