...
public abstract class GroupMemberImpl implements IGroupMember {
  ...
  /**
   * Returns the <code>Set</code> of groups in our member <code>Collection</code> and, recursively,
   * in the <code>Collections</code> of our members.
   *
   * @param member org.apereo.portal.groups.IGroupMember - The current group member in the recursive
   *     execution.
  ...
  public final int hashCode() {
    ...
    result =
        prime * result
            + ((underlyingEntityIdentifier == null) ? 0 : underlyingEntityIdentifier.hashCode());
    return result;
  }
  ...
  public final boolean equals(Object obj) {
    ...
    } else if (!underlyingEntityIdentifier.equals(other.underlyingEntityIdentifier)) return false;
    return true;
  }
