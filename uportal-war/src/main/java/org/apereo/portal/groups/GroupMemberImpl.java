...
public GroupMemberImpl(EntityIdentifier newEntityIdentifier) throws GroupsException {
    ...
    this.parentGroupsCache = cacheManager.getCache("org.apereo.portal.groups.GroupMemberImpl.parentGroups");
}
 ...
 * @param member org.apereo.portal.groups.IGroupMember - The current group member in the recursive execution.
