...
public interface IGroupMember extends IBasicEntity {
  ...
  /**
   * Returns an <code>Iterator</code> over the <code>Set</code> of this <code>IGroupMember's</code>
   ...
   * <code>Class</code> as applied to an <code>Array</code>; it is an attribute of the group object.
   * For an <code>IEntity</code>, it is the entity type of the group the entity belongs to, which
   * may be any <code>Class</code> the underlying entity can be legally cast to. Thus, an <code>
   * IEntity</code> with an underlying entity of type <code>Manager</code> could have an entity type
   * of <code>Employee</code> as long as <code>Employee</code> was a superclass of <code>Manager
   * </code>.
   */
