...
public class ReferenceComponentGroupService implements IComponentGroupService {
   ...
   * within this component. Used to assemble the composite.
   */
  protected Map componentServices = new HashMap();

  /**
   * The fully-qualified <code>Name</code> of the service, which may not be known until the
   * composite service is fully assembled.
   */
  ...
  /**
   * Returns the FULLY-QUALIFIED <code>Name</code> of the service, which may not be known until the
   * composite service is assembled.
   */
