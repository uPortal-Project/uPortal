...
/**
 * A tester for examining if an <code>IPerson</code> attribute has more than nth values.
 *
 * @author GIP RECIA - Julien Gribonvald
 * @since 5.0
 */
public final class NbValuesGTTester extends AbstractNbValuesTester {

  public NbValuesGTTester(IPersonAttributesGroupTestDefinition definition) {
    super(definition);
  }
   ...
   */
  @Deprecated
  public NbValuesGTTester(String attribute, String test) {
