...
public class MissingPropertyException extends RuntimeException {
  ...
  /**
   * True if a prior MissingPropertyException has been thrown for this missing property by the
   * throwing object if it keeps track. False otherwise.
   */
  private final boolean alreadyReported;

  /**
   * Instantiate a MissingPropertyException for a particular missing property, indicating whether
   * the throwing object has already thrown a MissingPropertyException for this property.
   *
   ...
   * particular missing property. Objects handling this exception might choose to predicate their
   * logging detail on this property, for instance.
   *
   * @return Returns true this property has already been reported as missing by the throwing object.
   */
