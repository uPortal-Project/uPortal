...
public class PropertiesManager {
   ...
   * static dependency injection of the Properties from wherever you want to get them. If Properties
   * have not been injected before any accessor method is invoked, PropertiesManager will invoke
   * loadProperties() to attempt to load its own properties. You might call this from a context
   * listener, say. If Properties have already been loaded or injected, this method will overwrite
   * them.
   *
   ...
   * value, but not including whitespace leading the property value. An UndeclaredPortalException is
   * thrown if the property cannot be found. This method will never return null.
   *
   * @param name the name of the requested property
   * @return value the value of the property matching the requested name
   ...
   * boolean in nature and you want to make sure that <code>true</code> is returned if the property
   * is set to "true", "yes", "y", or "on" (regardless of case), and <code>false</code> is returned
   * in all other cases.
   *
   * @param name the name of the requested property
   * @return value <code>true</code> if property is set to "true", "yes", "y", or "on" regardless of
  ...
  /**
   * Get the value of the property with the given name. If the named property is not found, returns
   * the supplied default value. This error handling behavior makes this method attractive for use
   * in static initializers.
   *
   * @param name - the name of the property to be retrieved.
   * @param defaultValue - a fallback default value which will be returned if the property cannot be
   *     found.
  ...
  /**
   * Get the value of the given property as a byte, specifying a fallback default value. If for any
   * reason we are unable to lookup the desired property, this method returns the supplied default
   * value. This error handling behavior makes this method suitable for calling from static
   * initializers.
   *
   * @param name - the name of the property to be accessed
  ...
  /**
   * Get the value of a given property as an int. If for any reason the property cannot be looked up
   * as an int, returns the supplied default value. This error handling makes this method a good
   * choice for static initializer calls.
   *
   * @param name - the name of the requested property
   * @param defaultValue - a fallback default value for the property
   * @return the value of the property as an int, or the supplied default value in the event of any
   *     problem.
   * @since uPortal 2.4
   */
  ...
  /**
   * Get the value of the given property as a long. If for any reason the property cannot be looked
   * up as a long, returns the supplied default value. This error handling makes this method a good
   * choice for static initializer calls.
   *
   * @param name - the name of the requested property
  ...
  /**
   * Get the value of the given property as a float. If for any reason the property cannot be looked
   * up as a float, returns the supplied default value. This error handling makes this method a good
   * choice for static initializer calls.
   *
   * @param name - the name of the requested property
   * @param defaultValue - a fallback default value that will be returned if there is any problem
