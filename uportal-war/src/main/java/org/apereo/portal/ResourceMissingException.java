...
public class ResourceMissingException extends PortalException {
  ...
  /**
   * Instantiate a ResourceMissingException providing the URI of the missing resource, a description
   * of the missing resource, and a message.
   *
  ...
  /**
   * Instantiate a ResourceMissingException providing the URI of the missing resource, a description
   * of the missing resource, and a cause.
   *
   * @param resourceURI URI of the missing resource
   * @param resourceDescription description of the missing resource
  ...
  /**
   * Instantiate a ResourceMissingException providing the URI of the missing resource, a description
   * of the missing resource, a message, and an underlying cause.
   *
   * @param resourceUri URI of the missing resource
