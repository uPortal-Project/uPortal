...
public class XalanLayoutElementTitleHelper {
   ...
   * element identifier format is 'uXlYnZ' where X stands for layout owners id, Y stands for layout
   * id, and Z stands for element (node) identifier, hence identifiers that start with 'u' are
   * considered as derived from layout owner.
   *
