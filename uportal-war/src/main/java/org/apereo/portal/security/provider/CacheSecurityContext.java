  ...
  public void authenticate(ISecurityContext parent) throws PortalSecurityException {
    ...
    if (this.myOpaqueCredentials.credentialstring != null) {
      ...
      String encryptedPassword =
          encryptionService.encrypt(new String(this.myOpaqueCredentials.credentialstring));
      ...
      System.arraycopy(
          encryptedPasswordBytes, 0, this.cachedcredentials, 0, encryptedPasswordBytes.length);
