...
public interface IAuthorizationPrincipal {
   ...
   * inherited <code>Permissions</code>.
   *
   ...
   * activity</code> on the <code>target</code>. Params <code>owner</code> and <code>activity</code>
   * must be non-null. If <code>target</code> is null, then the target is not checked.
   *
   * @return boolean
   * @param owner java.lang.String
   * @param activity java.lang.String
