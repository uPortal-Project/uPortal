...
public interface IAuthorizationService {
   ...
   * Params <code>owner</code> and <code>activity</code> must be non-null. If <code>target</code> is
   * null, then target is not checked. <br>
   ...
   * </code> must be non-null. If <code>target</code> is null, then target is not checked. <br>
   * NOTE: Do not invoke this method if there is a more specific method implemented. The more
