...
public interface IdentitySwapperManager {
  /**
   * Check if the currentUser can impersonate the targetUsername, returns true if they can, false if
   * not.
   */
   ...
   */
  void impersonateUser(
      PortletRequest portletRequest, String currentUserName, String targetUsername, String profile);
  ...
  /**
   * @return The original user if the current user is an impersonation, null if no impersonation is
   *     happening
   */
