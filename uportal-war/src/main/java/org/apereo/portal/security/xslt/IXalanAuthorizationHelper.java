...
public interface IXalanAuthorizationHelper {
     ...
     * @param channelFName Looks up the {@link org.apereo.portal.ChannelDefinition} with the
     *     matching fname
     ...
     * @return True if the user has permission to perform the specified action on the specified
     *     target
     */
