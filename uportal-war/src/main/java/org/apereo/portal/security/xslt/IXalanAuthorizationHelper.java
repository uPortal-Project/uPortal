...
public interface IXalanAuthorizationHelper {
   ...
   * @param channelFName Looks up the {@link org.apereo.portal.ChannelDefinition} with the matching
   *     fname
  ...
  /**
   * Checks if the specified user can perform the specified action. The target parameter should be
   * non-null where applicable, otherwise it is not checked.
   *
   ...
   * @return True if the user has permission to perform the specified action on the specified target
   */
