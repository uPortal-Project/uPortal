...
public interface IPermissionPolicy {
  ...
  /**
   * Answers if the owner has authorized the principal to perform the activity on the target, based
   * on permissions provided by the service. Params <code>service</code>, <code>owner</code> and
   ...
   * @return TRUE if the principal has permission to perform the specified activity on the specified
   *     target
