...
public abstract class ChainingSecurityContext implements ISecurityContext
{
  ...
  protected static boolean stopWhenAuthenticated = PropertiesManager.getPropertyAsBoolean("org.apereo.portal.security.provider.ChainingSecurityContext.stopWhenAuthenticated", DEFAULT_STOP_WHEN_AUTHENTICATED);
