...
public interface IUpdatingPermissionManager extends IPermissionManager {
  /**
   * Adds <code>IPermissions</code> to the store for the owner of this <code>IPermissionManager
   * </code>.
   *
  ...
  /**
   * Creates a new <code>IPermission</code> for the <code>principal</code> on behalf of the owner of
   * this <code>IPermissionManager</code>.
   *
   * @param principal IAuthorizationPrincipal
   */
  public IPermission newPermission(IAuthorizationPrincipal principal) throws AuthorizationException;
  /**
   * Removes <code>IPermissions</code> from the store for the owner of this <code>IPermissionManager
   * </code>.
   *
   * @param permissions IPermission[]
   */
  ...
  /**
   * Updates <code>IPermissions</code> in the store for the owner of this <code>IPermissionManager
   * </code>.
   *
   * @param permissions IPermission[]
   */
