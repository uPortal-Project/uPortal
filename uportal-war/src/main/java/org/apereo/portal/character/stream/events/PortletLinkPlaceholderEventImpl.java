...
public final class PortletLinkPlaceholderEventImpl extends PortletPlaceholderEventImpl
  ...
  private int internalHashCode() {
    ...
    result =
        prime * result
            + ((this.getDefaultPortletUrl() == null) ? 0 : this.getDefaultPortletUrl().hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!PortletNewItemCountPlaceholderEvent.class.isAssignableFrom(obj.getClass())) return false;
