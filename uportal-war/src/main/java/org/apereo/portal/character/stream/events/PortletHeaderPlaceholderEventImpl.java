 ...
 * @version $Revision$
 */
public final class PortletHeaderPlaceholderEventImpl extends PortletPlaceholderEventImpl
  ...
  private int internalHashCode() {
    ...
    result =
        prime * result
            + ((this.getPortletWindowId() == null) ? 0 : this.getPortletWindowId().hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (!PortletHeaderPlaceholderEvent.class.isAssignableFrom(obj.getClass())) return false;
  ...
  public String toString() {
    return "PortletHeaderPlaceholderEvent [" + "portletWindowId=" + this.getPortletWindowId() + "]";
  }
}
