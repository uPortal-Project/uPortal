...
public abstract class PortletPlaceholderEventSource extends BasePlaceholderEventSource {
  ...
  /**
   * Implement to generate CharacterEvents based on a {@link StartElement} match. If not implemented
   * throws UnsupportedOperationException
   */
  protected void generateCharacterEvents(
      IPortletWindowId portletWindowId, StartElement event, Collection<CharacterEvent> eventBuffer)
      throws XMLStreamException {
