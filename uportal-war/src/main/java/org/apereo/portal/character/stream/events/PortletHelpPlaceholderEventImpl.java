...
public final class PortletHelpPlaceholderEventImpl extends PortletPlaceholderEventImpl
  ...
  public boolean equals(Object obj) {
    ...
    if (!PortletHelpPlaceholderEvent.class.isAssignableFrom(obj.getClass())) return false;
  ...
  public String toString() {
    return "PortletHelpPlaceholderEvent [" + "portletWindowId=" + this.getPortletWindowId() + "]";
  }
}
