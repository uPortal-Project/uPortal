...
public interface CharacterEventSource {
   ...
   * {@link List} of {@link CharacterEvent}s based on the {@link StartElement}. The matching {@link
   * EndElement} should be read off of the {@link XMLEventReader} before returning.
   */
