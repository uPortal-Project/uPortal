...
public class PersonAttributesGroupStorePortalDataType extends AbstractPortalDataType {
  ...
  public static final PortalDataKey IMPORT_PAGS_GROUP_41_DATA_KEY =
      new PortalDataKey(
          PERSON_ATTRIBUTE_GROUP_STORE_TYPE_QNAME,
          "classpath://org/jasig/portal/io/import-pags-group_v4-1.crn",
          "GROUP");
  /** Pseudo type used to enforce the importing of all groups before any members */
  public static final PortalDataKey IMPORT_PAGS_MEMBERS_41_DATA_KEY =
      new PortalDataKey(
          PERSON_ATTRIBUTE_GROUP_STORE_TYPE_QNAME,
          "classpath://org/jasig/portal/io/import-pags-group_v4-1.crn",
          "MEMBERS");

  private static final List<PortalDataKey> PERSON_ATTRIBUTE_GROUP_STORE_DATA_KEYS =
      Arrays.asList(
          IMPORT_PAGS_41_DATA_KEY, IMPORT_PAGS_GROUP_41_DATA_KEY, IMPORT_PAGS_MEMBERS_41_DATA_KEY);

  private static final Set<PortalDataKey> PAGS_GROUP_MEMBERS_41_KEYS =
