...
public class TemplateUserPortalDataType extends AbstractPortalDataType {
  ...
  @Deprecated public static final QName LEGACY_TEMPLATE_USER_QNAME = new QName("template-user");

  public static final PortalDataKey IMPORT_40_DATA_KEY =
      new PortalDataKey(TEMPLATE_USER_QNAME, null, "4.0");

  /** @deprecated used for importing old data files */
  @Deprecated
  public static final PortalDataKey IMPORT_32_DATA_KEY =
      new PortalDataKey(
          LEGACY_TEMPLATE_USER_QNAME, "classpath://org/jasig/portal/io/import-user_v3-2.crn", null);

  /** @deprecated used for importing old data files */
  @Deprecated
  public static final PortalDataKey IMPORT_30_DATA_KEY =
      new PortalDataKey(
          LEGACY_TEMPLATE_USER_QNAME, "classpath://org/jasig/portal/io/import-user_v3-0.crn", null);

  /** @deprecated used for importing old data files */
  @Deprecated
  public static final PortalDataKey IMPORT_26_DATA_KEY =
      new PortalDataKey(
          LEGACY_TEMPLATE_USER_QNAME, "classpath://org/jasig/portal/io/import-user_v2-6.crn", null);

  private static final List<PortalDataKey> PORTAL_DATA_KEYS =
      Arrays.asList(IMPORT_26_DATA_KEY, IMPORT_30_DATA_KEY, IMPORT_32_DATA_KEY, IMPORT_40_DATA_KEY);
