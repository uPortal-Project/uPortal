...
public class ProfileImportHelper {
    ...
    public ProfileImportHelper(
            IStylesheetDescriptorDao stylesheetDescriptorDao,
            IStylesheetUserPreferencesDao stylesheetUserPreferencesDao,
            long structureStylesheetId,
            long themeStylesheetId,
            int personId,
            int profileId) {

        this.stylesheetUserPreferencesDao = stylesheetUserPreferencesDao;
        this.structureStylesheetDescriptor =
                stylesheetDescriptorDao.getStylesheetDescriptor(structureStylesheetId);
        this.themeStylesheetDescriptor =
                stylesheetDescriptorDao.getStylesheetDescriptor(themeStylesheetId);
    ...
    public void addStructureParameter(String name, String value) {
        if (this.structureStylesheetUserPreferences == null) {
            this.structureStylesheetUserPreferences =
                    this.getCreateStylesheetUserPreferences(this.structureStylesheetDescriptor);
        }
    ...
    public void addThemeParameter(String name, String value) {
        if (this.themeStylesheetUserPreferences == null) {
            this.themeStylesheetUserPreferences =
                    this.getCreateStylesheetUserPreferences(this.themeStylesheetDescriptor);
        }
    ...
    protected IStylesheetUserPreferences getCreateStylesheetUserPreferences(
        ...
        final IStylesheetUserPreferences stylesheetUserPreferences =
                this.stylesheetUserPreferencesDao.getStylesheetUserPreferences(
                        stylesheetDescriptor, personId, profileId);
        if (stylesheetUserPreferences != null) {
            return stylesheetUserPreferences;
        }

        return this.stylesheetUserPreferencesDao.createStylesheetUserPreferences(
                stylesheetDescriptor, personId, profileId);
    }
}
