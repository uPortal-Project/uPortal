...
public class PortalDataKey {
  /**
   * The XML Attribute on the root element that contains the cernunnos script that denotes the file
   * version. Used for data files from 3.2 and earlier.
   */
  ...
  /**
   * {@link #hashCode()} is called A LOT but never changes since this object and all field types are
   * immutable. A local variable is used to cache the calculated hash code
   */
  private int hash = 0;
