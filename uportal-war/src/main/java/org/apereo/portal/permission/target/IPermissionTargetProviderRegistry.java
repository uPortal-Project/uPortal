...
public interface IPermissionTargetProviderRegistry {
  ...
  /**
   * Retrieve a permission target provider instance for the given key. If no provider can be located
   * matching the given key, this method will return <code>null</code>.
   *
   * @param key
   * @return
   */
