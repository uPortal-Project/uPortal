...
public class RemoteCookieCheckController {
  ...
  public ModelAndView verifyCookiesEnabled(HttpServletRequest request, HttpServletResponse response)
    ...
    if (cookieFound) {
      String referer =
          (String) request.getSession().getAttribute(RemoteCookieCheckFilter.REFERER_ATTRIBUTE);
