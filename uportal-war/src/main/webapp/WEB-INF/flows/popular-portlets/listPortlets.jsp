...
<form id="${n}form">
  ...
  <div class="fl-widget-titlebar portlet-title" role="sectionhead">
  	<h2 role="heading"><spring:message code="popular-portlets.listPortlets.title"/></h2>
  </div> <!-- end: portlet-title -->
  
  <!-- Portlet Toolbar -->
  <div class="portlet-toolbar" role="toolbar">
    <spring:message code="popular-portlets.listPortlets.daysLabelBefore"/>
    ...
    <spring:message code="popular-portlets.listPortlets.daysLabelAfter"/>
    <c:if test="${showAdminFeatures}">
      <spring:message code="popular-portlets.listPortlets.fromDateLabelBefore"/>
      <input id="${n}fromDate" name="fromDate" type="text" class="cal-datepicker" value="<spring:message code="popular-portlets.listPortlets.fromDateLabelInner"/>"/>
      <spring:message code="popular-portlets.listPortlets.fromDateLabelAfter"/>
    </c:if>
  ...
  <div class="fl-widget-content portlet-body" role="main">
  	...
  	<div class="portlet-msg-info" role="status" id="${n}loadingMessage">
    	<h3><spring:message code="popular-portlets.listPortlets.loadingTitle"/></h3>
    	<p><spring:message code="popular-portlets.listPortlets.loadingMessage"/></p>
    </div> <!-- end: portlet-msg -->
    ...
    <div id="${n}popularPortlets" class="portlet-section fl-pager" role="region">      
      ...
      <div class="view-pager flc-pager-top portlet-section-options">
        <ul id="pager-top" class="fl-pager-ui">
          <li class="flc-pager-previous"><a href="#">&lt; <spring:message code="popular-portlets.listPortlets.pagerPrevious"/></a></li>
          <li>
          ...
          <li class="flc-pager-next"><a href="#"><spring:message code="popular-portlets.listPortlets.pagerNext"/> &gt;</a></li>
          <li>
            <span class="flc-pager-summary"><spring:message code="popular-portlets.listPortlets.pagerPerPagePrefix"/></span>
            ...
            </select></span> <spring:message code="popular-portlets.listPortlets.pagerPerPageSuffix"/>
          </li>
        </ul>
      ...
      <div class="portlet-section-body">
        <table id="${n}portletsTable" summary="" xmlns:rsf="http://ponder.org.uk" style="width:100%;">
          <thead>
            <tr rsf:id="header:">
              <th id="${n}portletTitle" class="flc-pager-sort-header"><a rsf:id="title" title="Click to sort" href="javascript:;"><spring:message code="popular-portlets.listPortlets.portletTableTitleHeading"/></a></th>
              <th id="${n}portletCount" class="flc-pager-sort-header"><a rsf:id="count" title="Click to sort" href="javascript:;"><spring:message code="popular-portlets.listPortlets.portletTableCountHeading"/></a></th>
            </tr>
          </thead>
      ...
      <div id="${n}noneAdded" style="display: none;">
        <p><spring:message code="popular-portlets.listPortlets.noneAdded"/></p>
      </div> 
      ...
      <c:if test="${showAdminFeatures}">
        ...
        <div class="portlet-button-group">
          ...
          <a class="portlet-button portlet-button-primary" href="${doneUrl}"><spring:message code="popular-portlets.listPortlets.doneButton"/></a>
        </div>
      </c:if>
...
up.jQuery(function() {
    ...
    var fetchStats = function() {
        ...
        $.ajax({
            url: '<c:url value="/mvc/userLayoutModificationsCounts"/>',
            async: false,
