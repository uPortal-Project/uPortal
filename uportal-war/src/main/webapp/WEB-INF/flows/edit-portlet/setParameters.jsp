...
<div class="fl-widget portlet ptl-mgr view-setparameters" role="section">
    ...
    <div class="fl-widget-titlebar titlebar portlet-titlebar" role="sectionhead">
        <h2 class="title" role="heading"><spring:message code="${ completed ? 'edit.portlet' : 'register.new.portlet' }"/></h2>
        ...
        <form:form modelAttribute="portlet" action="${queryUrl}" method="POST">
            ...
            <c:if test="${supportsConfig}">
                <div class="portlet-msg-info portlet-msg info" role="alert">
                    <p class="text-info"><span class="label label-info"><spring:message code="note"/></span><spring:message code="this.portlet.supports.rich.config.message"/></p>
                </div>
            </c:if>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <tr>
                                                ...
                                                <td><editPortlet:parameterInput input="${ parameter.parameterInput.value }"path="${ paramPath }"/></td>
                                            </tr>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <tr>
                                                        ...
                                                        <td><editPortlet:preferenceInput input="${ preference.preferenceInput.value }" path="${ paramPath }" name="${ preference.name }" values="${ portlet.portletPreferences[preference.name].value }"/></td>
                                        ...
                                        <c:forEach items="${ arbitraryPreferenceNames }" var="name">
                                            ...
                                            <td>
                                                ...
                                                <div>
                                                    ...
                                                    <a class="delete-parameter-value-link btn btn-xs btn-primary" href="javascript:;">Remove This<i class="fa fa-trash"></i></a>
                                                </div>
                                                </c:forEach>
