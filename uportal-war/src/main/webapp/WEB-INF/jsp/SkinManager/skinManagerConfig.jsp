            ...
            <div class="portlet-section-body">
                ...
                <form role="form" class="form-horizontal" action="${ formUrl }" method="POST">
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><spring:message code="skin.manager.color1"/></label>
                        <input type="color" class="colorPicker" name="color1" value="${color1}"/>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><spring:message code="skin.manager.color2"/></label>
                        <input type="color" class="colorPicker" name="color2" value="${color2}"/>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><spring:message code="skin.manager.color3"/></label>
