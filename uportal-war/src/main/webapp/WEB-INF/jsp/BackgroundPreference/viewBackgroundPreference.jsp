    ...
    var BackgroundChanger = function() {
        ...
        var changeBackground = function() {
            if (elements.background) {
                ...
                elements.coreElement.css({'background': 'url('+elements.background+')', 'background-size': 'cover'});
            } else {
                elements.coreElement.css({'background': ''});
            }
        };
        ...
        var privateInit = function() {
            ...
            elements.coreElement = ($('#portalPageBody').size() > 0) ? $('#portalPageBody') : $('html')
        ...
        (function init() {
            ...
            $(function() {
                // Hack to set the Redirect location field value.  This is needed to persist the background image
