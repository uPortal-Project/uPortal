...
<div id="${n}" class="marketplace_wrapper">
	<div>
	 	...
	 	<br>
	 	<c:if test="${not empty Portlet.portletVersion.version}">
	 		<div class="row">
		 		<div class = "col-xs-12 col-md-4">
		 			<p>
		 			...
		 			<p>
		 				<span class="marketplace_version">Version&nbsp;${Portlet.portletVersion.version}</span>
		 				<c:if test="${not empty Portlet.portletVersion.releaseDate}">
		 					<span class="marketplace_release_date">&nbsp;(Released ${Portlet.portletVersion.releaseDate})</span>
		 				</c:if>
		 				<br>
		 				<c:if test="${not empty Portlet.portletVersion.releaseNotes}">
		 					<ul class="marketplace_release_notes">
		 						<c:forEach var="releaseNote" items="${Portlet.portletVersion.releaseNotes}">
									<li class="marketplace_release_note">- &nbsp;${releaseNote}</li>
								</c:forEach>
							</ul>
		 				</c:if>
		 			</p>
		 			<c:if test="${fn:length(Portlet.portletVersion.releaseNotes) gt 3}">
