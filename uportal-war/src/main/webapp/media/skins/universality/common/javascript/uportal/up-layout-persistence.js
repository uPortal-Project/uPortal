...
(function($, fluid){
     ...
     */
    uportal.LayoutPersistence = function(container, options) {
        
        // construct the new component
        var that = fluid.initView("uportal.LayoutPersistence", container, options);
    ...
    // defaults
    fluid.defaults("uportal.LayoutPersistence", {
        saveLayoutUrl: null,
        selectors: {
