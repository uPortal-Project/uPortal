...
<!--
 ...
 | for use in rendering the uPortal UI using Javascript. A new endpoint,
...
<xsl:stylesheet
    ...
    xmlns:upJsonTool="http://xml.apache.org/xalan/java/org.apereo.portal.security.xslt.XalanRestJsonHelper"
    xsi:schemaLocation="
