...
public class UserAccountHelperTest {
  ...
  public void setUp() {
    ...
    when(messageSource.getMessage(
            "attribute.displayName.username", new Object[] {}, "username", locale))
        .thenReturn("Net ID");
    when(messageSource.getMessage(
            "attribute.displayName.user.login.id", new Object[] {}, "user.login.id", locale))
        .thenReturn("Net ID");
    when(messageSource.getMessage("attribute.displayName.mail", new Object[] {}, "mail", locale))
        .thenReturn("Email");
    when(messageSource.getMessage(
            "attribute.displayName.displayName", new Object[] {}, "displayName", locale))
        .thenReturn("Full Name");
  }
