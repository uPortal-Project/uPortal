...
public class DefaultStatisticsReportLabellingStrategyTest {
  ...
  public void testTwoSingle() {
    ...
    assertEquals(
        bob1.getCriteriaItem(), object.getColumnDescriptions(items, false, form).get(0).getLabel());
  }
  ...
  public void testSingleMultiple() {
    ...
    assertEquals(
        sam2.getCriteriaItem(), object.getColumnDescriptions(items, false, form).get(0).getLabel());
  }
  ...
  public void testMultipleSingle() {
    ...
    assertEquals(sam1.getCriteriaItem(), object.getReportTitleAugmentation(items));
    assertEquals(
        bob2.getCriteriaItem(), object.getColumnDescriptions(items, false, form).get(0).getLabel());
  }
