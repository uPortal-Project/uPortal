...
import org.apereo.portal.rendering.StylesheetAttributeSource;
...
public class StylesheetAttributeSourceForSpELVariablesTest {
    ...
    public void setUp() throws Exception {
        ...
        given(this.stylesheetUserPreferencesService.getStylesheetDescriptor(this.request, PreferencesScope.STRUCTURE)).willReturn(this.stylesheetDescriptor);
        given(this.stylesheetDescriptor.getLayoutAttributeDescriptors()).willReturn(this.layoutAttributeDescriptors);
        given(this.startEvent.getName()).willReturn(this.qName);
        given(this.startEvent.getAttributeByName(IUserLayoutManager.ID_ATTR_NAME)).willReturn(this.subscribeIdAttr);
    ...
    @Test
    public void getAdditionalAttributesMethodShouldReturnSpELEvaluatedValueForLayoutAttributeDefault() {
        // given
        final String layoutAttributeValue = this.wrapAsSpELExpressionAttributeVariable(this.spelExpression);
        this.layoutAttributeWithDefaultValueFoundForName(this.layoutAttributeName, layoutAttributeValue);
        ...
        // when
        final Iterator<Attribute> resultsIterator = this.source.getAdditionalAttributes(this.request, this.response, this.startEvent);
    ...
    @Test
    public void getAdditionalAttributesMethodShouldReturnSpELEvaluatedValueForUserPreferenceLayoutAttribute() {
        // given
        final String layoutAttributeValue = this.wrapAsSpELExpressionAttributeVariable(this.spelExpression);
        this.layoutAttributeWithNoDefaultValueFoundForName(this.layoutAttributeName);
        this.layoutAttributeValueFoundInUserPreferences(this.layoutAttributeName, layoutAttributeValue);
        this.spELEvaluatedValueForInputWillBe(this.spelExpression, this.studentId);
        // when
        final Iterator<Attribute> resultsIterator = this.source.getAdditionalAttributes(this.request, this.response, this.startEvent);
        final List<Attribute> results = this.getResultsUsingIterator(resultsIterator);
    ...
    public void getAdditionalAttributesMethodShouldNotDoSpELEvaluationForNonSpELVariable() {
        // given
        final String layoutAttributeValue = this.spelExpression; // note that this value is not wrapped in ${ ... }
        this.layoutAttributeWithNoDefaultValueFoundForName(this.layoutAttributeName);
        this.layoutAttributeValueFoundInUserPreferences(this.layoutAttributeName, layoutAttributeValue);
        // when
        final Iterator<Attribute> resultsIterator = this.source.getAdditionalAttributes(this.request, this.response, this.startEvent);
        ...
        verify(this.portalSpELService, never()).getValue(any(Expression.class), any(WebRequest.class), eq(String.class));
        this.assertSingleResultWithCorrectValues(results, this.layoutAttributeName, layoutAttributeValue);
    }

    @Test
    public void getAdditionalAttributesMethodShouldReturnNonSpELEvaluatedLayoutAttributeValueWhenParseExceptionThrown() {
        // given
    	final String layoutAttributeValue = this.wrapAsSpELExpressionAttributeVariable(this.spelExpression);
        this.layoutAttributeWithDefaultValueFoundForName(this.layoutAttributeName, layoutAttributeValue);
        this.layoutAttributeValueNotFoundInUserPreferences(this.layoutAttributeName);
    ...
    @Test
    public void getAdditionalAttributesMethodShouldReturnNonSpELEvaluatedLayoutAttributeValueWhenEvaluationExceptionThrown() {
        // given
    	final String layoutAttributeValue = this.wrapAsSpELExpressionAttributeVariable(this.spelExpression);
        this.layoutAttributeWithDefaultValueFoundForName(this.layoutAttributeName, layoutAttributeValue);
        this.layoutAttributeValueNotFoundInUserPreferences(this.layoutAttributeName);
    ...
    private void layoutAttributeValueFoundInUserPreferences(final String layoutAttributeName, final String value) {
        given(this.stylesheetUserPreferencesService.getLayoutAttribute(this.request, this.stylesheetPreferencesScope, this.subscribeId, layoutAttributeName)).willReturn(value);
    }

    private void layoutAttributeValueNotFoundInUserPreferences(final String layoutAttributeName) {
        given(this.stylesheetUserPreferencesService.getLayoutAttribute(this.request, this.stylesheetPreferencesScope, this.subscribeId, layoutAttributeName)).willReturn(null);
    }

    private void layoutAttributeWithDefaultValueFoundForName(final String layoutAttributeName, final String defaultValue) {
    ...
    private void layoutAttributeDescriptorReturnsTargetElementNames(ILayoutAttributeDescriptor descriptor, final String...strings) {
    ...
    private void spELEvaluatedValueForInputWillBe(final String input, final String value) {
        ...
        given(this.portalSpELService.getValue(eq(expression), any(WebRequest.class), eq(String.class))).willReturn(value);
    }

    private void spELParsingForInputThrowsParseException(final String input) {
        given(this.portalSpELService.parseExpression(input)).willThrow(new ParseException(0, input));
    }
    ...
    private void assertSingleResultWithCorrectValues(List<Attribute> results, final String name, final String value) {
