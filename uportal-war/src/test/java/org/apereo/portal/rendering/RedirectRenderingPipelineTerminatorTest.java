...
public class RedirectRenderingPipelineTerminatorTest {
     ...
     */
    @Test
    public void redirectsToConfiguredPath() throws ServletException, IOException {

        final RedirectRenderingPipelineTerminator terminator =
                new RedirectRenderingPipelineTerminator();
    ...
    /**
     * Test that RedirectRenderingPipelineTerminator throws IllegalStateException if invoked without
     * the redirect target having been set.
     *
     * @throws ServletException never, this would be a test failure.
     * @throws IOException never, this would be a test failure.
     */
    ...
    public void throwsIllegalStateExceptionWhenRedirectToNotSet()
        ...
        final RedirectRenderingPipelineTerminator unconfiguredTerminator =
                new RedirectRenderingPipelineTerminator();
    ...
    public void throwsIllegalArgumentExceptionOnSettingRedirectPathToNull() {
        ...
        final RedirectRenderingPipelineTerminator badlyConfiguredTerminator =
                new RedirectRenderingPipelineTerminator();
