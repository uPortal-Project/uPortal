...
public class IncludeExcludeUtilsTest {
  ...
  public void testNoIncExc() {
    ...
    assertTrue(
        IncludeExcludeUtils.included(AggregationInterval.CALENDAR_QUARTER, includes, excludes));
  ...
  public void testSingleInclude() {
    ...
    assertFalse(
        IncludeExcludeUtils.included(AggregationInterval.ACADEMIC_TERM, includes, excludes));
    assertFalse(
        IncludeExcludeUtils.included(AggregationInterval.CALENDAR_QUARTER, includes, excludes));
