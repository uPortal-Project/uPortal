...
public class RandomTokenGeneratorTest {
    ...
    public void testTokenLengthMath31() {
        ...
        for (int length = 0; length < 10000; length++) {
            ...
            final int reqLengthMin =
                    randomTokenGenerator.getLengthRequiredForBits((int) Math.floor(bits));
            final int reqLengthMax =
                    randomTokenGenerator.getLengthRequiredForBits((int) Math.ceil(bits));
    ...
    public void testTokenLengthMath32() {
        final RandomTokenGenerator randomTokenGenerator =
