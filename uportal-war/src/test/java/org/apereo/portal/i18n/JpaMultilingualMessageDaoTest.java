        ...
        new Callable<Object>() {
          ...
          public Object call() throws Exception {
            ...
            final Message msgUS2 =
                messageDao.createMessage("Test message 2", new Locale("en_US"), "Test message2");
            final Message msgLV =
                messageDao.createMessage(code, new Locale("lv_LV"), "Testa ziņojums");
            final Message msgDE =
                messageDao.createMessage(code, new Locale("de_DE"), "Testnachricht");
