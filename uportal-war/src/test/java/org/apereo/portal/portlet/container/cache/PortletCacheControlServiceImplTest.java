...
public class PortletCacheControlServiceImplTest {
  @InjectMocks
  private PortletCacheControlServiceImpl cacheControlService = new PortletCacheControlServiceImpl();
  ...
  public void testGetCacheControlDataExistsInPrivateCache() {
    ...
    final CacheState<CachedPortletData<PortletRenderResult>, PortletRenderResult> afterCacheState =
  ...
  public void testCachePrivateRenderRoundTrip() {
    ...
    final CacheState<CachedPortletData<PortletRenderResult>, PortletRenderResult> firstCacheState =
        cacheControlService.getPortletRenderState(httpRequest, portletWindowId);
    ...
    final CacheState<CachedPortletData<PortletRenderResult>, PortletRenderResult> secondCacheState =
        cacheControlService.getPortletRenderState(httpRequest, portletWindowId);

    assertNotNull(secondCacheState);
    final CachedPortletData<PortletRenderResult> actualCachedPortletData =
        secondCacheState.getCachedPortletData();
  ...
  public void testCachePrivateResourceRoundTrip() {
    ...
    assertNotNull(secondCacheState);
    final CachedPortletResourceData<Long> actualCachedPortletData =
        secondCacheState.getCachedPortletData();
    assertNotNull(actualCachedPortletData);
  }
}
