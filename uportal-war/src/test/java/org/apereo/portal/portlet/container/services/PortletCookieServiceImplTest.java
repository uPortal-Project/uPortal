...
public class PortletCookieServiceImplTest {
  ...
  /**
   * Test {@link
   * PortletCookieServiceImpl#getOrCreatePortalCookie(javax.servlet.http.HttpServletRequest)}. that
   * results in creating a new PortalCookie.
   */
  @Test
   ...
   * Test {@link
   * PortletCookieServiceImpl#getOrCreatePortalCookie(javax.servlet.http.HttpServletRequest)}. that
   * results in returning an existing portalcookie from the request cookies
   */
  @Test
   ...
   * Test {@link
   * PortletCookieServiceImpl#getOrCreatePortalCookie(javax.servlet.http.HttpServletRequest)}. that
   * results in returning an existing portalcookie from the id stored in the session.
   */
  @Test
  public void testGetOrCreatePortalCookieGetExistingFromSession() {
    ...
    request
        .getSession()
        .setAttribute(PortletCookieServiceImpl.SESSION_ATTRIBUTE__PORTAL_COOKIE_ID, "ABCDEF");
  ...
  /**
   * Control test for removing a portlet cookie. Logic is nearly identical to create, as both {@link
   * IPortletCookieDao#addOrUpdatePortletCookie(IPortalCookie, Cookie)} is used in both scenarios.
   */
  @Test
