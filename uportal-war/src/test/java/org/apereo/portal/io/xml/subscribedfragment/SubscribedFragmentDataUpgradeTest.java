...
public class SubscribedFragmentDataUpgradeTest extends BaseXsltDataUpgraderTest {
    ...
    public void testUpgradeUser32to40() throws Exception {
        testXsltUpgrade(
                new ClassPathResource("/org/apereo/portal/io/xml/subscribed-fragment/upgrade-subscribed-fragment_3-2.xsl"),
                SubscribedFragmentPortalDataType.IMPORT_32_DATA_KEY,
                new ClassPathResource("/org/apereo/portal/io/xml/subscribed-fragment/test_3-2.subscribed-fragment.xml"),
                new ClassPathResource("/org/apereo/portal/io/xml/subscribed-fragment/test_4-0.subscribed-fragment.xml"),
