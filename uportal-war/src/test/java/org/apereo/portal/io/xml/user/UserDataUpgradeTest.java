...
public class UserDataUpgradeTest extends BaseXsltDataUpgraderTest {
    ...
    public void testUpgradeUser26to40() throws Exception {
        testXsltUpgrade(
                ...
                new ClassPathResource("/org/apereo/portal/io/xml/user/test_2-6_to_4-0_expected.user.xml"),
    ...
    public void testUpgradeUser30to40() throws Exception {
        testXsltUpgrade(
                ...
                new ClassPathResource("/org/apereo/portal/io/xml/user/test_3-0_to_4-0_expected.user.xml"),
                new ClassPathResource("/xsd/io/user/user-4.0.xsd"));
    }
    ...
    public void testUpgradeUser32to40() throws Exception {
        testXsltUpgrade(
                ...
                new ClassPathResource("/org/apereo/portal/io/xml/user/test_3-2_to_4-0_expected.user.xml"),
                new ClassPathResource("/xsd/io/user/user-4.0.xsd"));
    }
}
