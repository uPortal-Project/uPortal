...
public class IdentityImportExportTest extends BasePortalJpaDaoTest {
    ...
    public void testStylesheetDescriptor40ImportExport() throws Exception {
        final ClassPathResource stylesheetDescriptorResource = new ClassPathResource("/org/apereo/portal/io/xml/ssd/test_4-0.stylesheet-descriptor.xml");
    ...
    public void testPermissionOwner40ImportExport() throws Exception {
        final ClassPathResource permissionOwnerResource = new ClassPathResource("/org/apereo/portal/io/xml/permission-owner/test_4-0.permission-owner.xml");
    ...
    public void testUser40ImportExport() throws Exception {
        final ClassPathResource dataResource = new ClassPathResource("/org/apereo/portal/io/xml/user/test_4-0.user.xml");
