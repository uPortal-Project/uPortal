...
public class JpaTabRenderAggregationDaoTest
    extends JpaBaseAggregationDaoTest<
        TabRenderAggregationImpl, TabRenderAggregationKey, TabRenderAggregationDiscriminator> {
  ...
  protected void updateAggregation(
      AggregationIntervalInfo intervalInfo, TabRenderAggregationImpl aggregation, Random r) {
  ...
  protected TabRenderAggregationKey createAggregationKey(
    ...
    final AggregatedTabMapping mappedTab =
        this.aggregatedTabLookupDao.getMappedTabForLayoutId("u1l1n1");
  ...
  protected Map<TabRenderAggregationKey, TabRenderAggregationImpl> createAggregations(
    ...
    final AggregatedTabMapping mappedTab =
        this.aggregatedTabLookupDao.getMappedTabForLayoutId("u1l1n1");
    final TabRenderAggregationKeyImpl key =
