...
/**
 * Utility used to create portal events for testing. Events all use package-private constructors but
...
public final class TestEventFactory {
    ...
    public static LoginEvent newLoginEvent(
            Object source,
            String serverName,
        ...
        final PortalEventBuilder portalEventBuilder =
                new PortalEventBuilder(source, serverName, eventSessionId, person, null);
