...
public class JpaPortletExecutionAggregationDaoTest
  ...
  protected void updateAggregation(
      AggregationIntervalInfo intervalInfo, PortletExecutionAggregationImpl aggregation, Random r) {
  ...
  protected PortletExecutionAggregationKey createAggregationKey(
    ...
    final AggregatedPortletMapping mappedPortlet =
        aggregatedPortletLookupDao.getMappedPortletForFname("Foo");
  ...
  protected PortletExecutionAggregationKey createAggregationKey(
    ...
    final AggregatedPortletMapping mappedPortlet =
        aggregatedPortletLookupDao.getMappedPortletForFname("Foo");
    return new PortletExecutionAggregationKeyImpl(
        interval, aggregatedGroup, mappedPortlet, ExecutionType.ALL);
  }
  ...
  protected Map<PortletExecutionAggregationKey, PortletExecutionAggregationImpl> createAggregations(
    ...
    final AggregatedPortletMapping mappedPortlet =
        aggregatedPortletLookupDao.getMappedPortletForFname("Foo");
    final PortletExecutionAggregationKeyImpl key =
        new PortletExecutionAggregationKeyImpl(
            ...
            mappedPortlet,
            ExecutionType.ALL);
    final PortletExecutionAggregationImpl aggr =
        portletExecutionAggregationDao.createAggregation(key);
    return Collections
        .<PortletExecutionAggregationKey, PortletExecutionAggregationImpl>singletonMap(key, aggr);
  }
}
