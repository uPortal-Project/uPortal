...
public class JpaConcurrentUserAggregationDaoTest
  ...
  protected void updateAggregation(
      AggregationIntervalInfo intervalInfo, ConcurrentUserAggregationImpl aggregation, Random r) {
  ...
  protected Map<ConcurrentUserAggregationKey, ConcurrentUserAggregationImpl> createAggregations(
    ...
    final TimeDimension timeDimension = intervalInfo.getTimeDimension();
    final AggregationInterval aggregationInterval = intervalInfo.getAggregationInterval();
    final ConcurrentUserAggregationKeyImpl key =
    ...
    return Collections.<ConcurrentUserAggregationKey, ConcurrentUserAggregationImpl>singletonMap(
        key, aggr);
  }
}
