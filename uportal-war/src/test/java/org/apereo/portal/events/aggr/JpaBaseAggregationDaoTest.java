            ...
            new Callable<Map<K, T>>() {
              ...
              public Map<K, T> call() throws Exception {
                ...
                final AggregationIntervalInfo hourInfo =
                    aggregationIntervalHelper.getIntervalInfo(AggregationInterval.HOUR, instant);
    ...
    this.execute(
        new CallableWithoutResult() {
          ...
          protected void callWithoutResult() {
            final AggregationIntervalInfo fiveMinuteInfo =
                aggregationIntervalHelper.getIntervalInfo(AggregationInterval.FIVE_MINUTE, instant);
            final AggregationIntervalInfo hourInfo =
                aggregationIntervalHelper.getIntervalInfo(AggregationInterval.HOUR, instant);
        ...
        new CallableWithoutResult() {
          ...
          protected void callWithoutResult() {
            ...
            final List<T> baseAggregations =
                getAggregationDao()
                    .getAggregations(
                        queryStart, queryEnd, createAggregationKey(interval, groupA), groupB);
        ...
        new CallableWithoutResult() {
          ...
          protected void callWithoutResult() {
            ...
            final List<T> baseAggregations =
                getAggregationDao()
                    .getAggregations(
                        start, end.plusDays(1), createAggregationKey(interval, groupA), groupB);
    ...
    this.execute(
        new CallableWithoutResult() {
          ...
          protected void callWithoutResult() {
            ...
            final List<T> baseAggregations =
                getAggregationDao()
                    .getAggregations(start, end, createAggregationKey(interval, groupA), groupB);
        ...
        new CallableWithoutResult() {
          ...
          protected void callWithoutResult() {
            ...
            final List<T> baseAggregations =
                getAggregationDao()
                    .getAggregations(
                        start, start.plusHours(12), createAggregationKey(interval, groupA), groupB);
        ...
        new CallableWithoutResult() {
          ...
          protected void callWithoutResult() {
            ...
            final List<T> aggregations =
                getAggregationDao().getAggregations(start.minusDays(1), end.plusDays(1), key);
          ...
          public List<RT> call() throws Exception {
            ...
            while (nextDateTime.isBefore(end)) {
              ...
              if (newDimensionHandler != null) {
                final RT result =
                    newDimensionHandler.apply(new Tuple<DateDimension, TimeDimension>(dd, td));
                if (result != null) {
                  results.add(result);
                }
              }
