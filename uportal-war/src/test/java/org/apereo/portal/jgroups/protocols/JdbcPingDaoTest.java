...
public class JdbcPingDaoTest extends BasePortalJpaDaoTest {
    ...
    @Autowired private PingDao pingDao;
        ...
        this.execute(
                new CallableWithoutResult() {
                    ...
                    protected void callWithoutResult() {
                        final Map<Address, PhysicalAddress> addresses =
                                pingDao.getAddresses(cluster);
                ...
                new CallableWithoutResult() {
                    ...
                    protected void callWithoutResult() {
                        final Collection<Address> addresses =
                                Arrays.<Address>asList(ipAddress, ipAddress2);
        ...
        this.execute(
                new CallableWithoutResult() {
                    ...
                    protected void callWithoutResult() {
                        ...
                        final Entry<Address, PhysicalAddress> entry =
                                addresses.entrySet().iterator().next();
