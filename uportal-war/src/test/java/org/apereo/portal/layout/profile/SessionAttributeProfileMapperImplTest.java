...
public class SessionAttributeProfileMapperImplTest {
  ...
  /**
   * Test that when aware of a desired profile selection, and that desire maps to a configured
   * profile fname, then performs that mapping.
   *
   * <p>This is the happy path, normal case.
   */
  @Test
  public void testMapsToProfileIndicatedByRequestedKey() {
    ...
    final ProfileSelectionEvent selectionEvent =
        new ProfileSelectionEvent(this, "key2", person, request);
  ...
  /**
   * Test that when not aware of a desired profile selection, returns the configured default profile
   * name.
   */
  @Test
  ...
  /**
   * Test that when aware of a desired profile selection, but that desire does not map to a
   * configured profile fname, then returns unconfigured default.
   */
  @Test
  ...
  /**
   * Test that when aware of a desired profile selection, but that desire does not map to a
   * configured profile fname, then returns configured default.
   */
  @Test
