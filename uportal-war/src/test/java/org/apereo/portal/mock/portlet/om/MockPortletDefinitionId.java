...
public class MockPortletDefinitionId implements IPortletDefinitionId {
  ...
  public boolean equals(Object object) {
    ...
    return new EqualsBuilder().append(this.portletDefinitionId, rhs.getStringId()).isEquals();
  }

  /** @see java.lang.Object#hashCode() */
  @Override
  public int hashCode() {
    return new HashCodeBuilder(-917388291, 674832463).append(this.portletDefinitionId).toHashCode();
  }
