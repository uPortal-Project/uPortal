...
public abstract class BaseJpaDaoTest {
          ...
          this.executeInTransaction(
              new CallableWithoutResult() {
                ...
                protected void callWithoutResult() {
                  ...
                  final Query query =
                      entityManager.createQuery("SELECT e FROM " + entityClassName + " AS e");
  ...
  /**
   * Executes the callback in a new thread inside of a {@link JpaInterceptor}. Waits for the Thread
   * to return.
   */
