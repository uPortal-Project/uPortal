...
public class RestrictedPersonTest extends TestCase {
  ...
  /**
   * Test that the getEntityIdentifier() method of RestrictedPerson reads through to the underlying
   * IPerson's entity identifier.
   */
  ...
  /**
   * Test that the setFullName method of RestrictedPerson writes through to the underlying IPerson.
   */
