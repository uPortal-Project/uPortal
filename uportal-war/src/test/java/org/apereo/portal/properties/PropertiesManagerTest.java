...
public class PropertiesManagerTest extends TestCase {
  ...
  protected void tearDown() throws Exception {
    ...
    if (this.systemPropertyValue != null)
      System.setProperty(
          PropertiesManager.PORTAL_PROPERTIES_FILE_SYSTEM_VARIABLE, this.systemPropertyValue);
  }

  /**
   * Test the getProperty method. Tests ability to retrieve a property from sample properties file.
  ...
  /**
   * Test that getPropertyAsByte() throws proper runtime exception when the property value cannot be
   * parsed as a byte.
   */
  ...
  /**
   * Test that getPropertyAsInt() throws proper runtime exception when the property value cannot be
   * parsed as an int.
   */
  ...
  /**
   * Test that getPropertyAsLong() throws proper runtime exception when the property value cannot be
   * parsed as a byte.
   */
  ...
  /**
   * Test that getPropertyAsDouble() throws proper runtime exception when the property value cannot
   * be parsed as a byte.
   */
  ...
  public void testGetMissingProperties() {
    ...
    assertEquals(
        "defaultValue", PropertiesManager.getProperty("emphaticallyMissing", "defaultValue"));
