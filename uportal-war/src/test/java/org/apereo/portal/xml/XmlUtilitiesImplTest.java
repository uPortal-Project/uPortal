...
public class XmlUtilitiesImplTest {
    ...
    private Document loadTestDocument() throws IOException, SAXException {
        final InputStream testDocStream =
                this.getClass().getResourceAsStream("/org/apereo/portal/xml/xmlUtilitiesTest.xml");
        final Document testDoc =
                DocumentFactory.getDocumentFromStream(testDocStream, "xmlUtilitiesTest.xml");
