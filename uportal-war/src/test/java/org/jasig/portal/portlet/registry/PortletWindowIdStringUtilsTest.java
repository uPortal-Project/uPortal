...
public class PortletWindowIdStringUtilsTest {
    ...
    @Test
    public void convertToDelegateLayoutNodeIdMethodShouldReturnCorrectResultWhenPortletWindowIdHasNoWindowInstanceId() {
        // given
        final String portletWindowIdString = "88_n149_52";
        // when
        final String result = PortletWindowIdStringUtils.convertToDelegateLayoutNodeId(portletWindowIdString);
        // then
        assertEquals("dlg-88-n149-52", result);
    }

    @Test
    public void convertToDelegateLayoutNodeIdMethodShouldReturnCorrectResultWhenPortletWindowIdHasWindowInstanceId() {
        // given
    ...
    public void formatMethodShouldReturnCorrectResultWhenTheWindowInstanceIdIsNotNull() {
        ...
        // when
        final String result = PortletWindowIdStringUtils.format(portletEntityIdString, portletWindowInstanceIdString);
        // then
    ...
    @Test
    public void hasCorrectNumberOfPartsMethodShouldReturnTrueWhenPortletWindowIdHasNoWindowInstanceId() {
        // given
        final String portletWindowIdString = "90_u110_18";
        // when
        final boolean result = PortletWindowIdStringUtils.hasCorrectNumberOfParts(portletWindowIdString);
        // then
        assertTrue(result);
    }

    @Test
    public void hasCorrectNumberOfPartsMethodShouldReturnTrueWhenPortletWindowIdHasWindowInstanceId() {
        // given
    ...
    public void parsePortletEntityIdMethodShouldReturnResultEqualToInputWhenPortletWindowIdHasNoWindowInstanceId() {
        ...
        // when
        final String result = PortletWindowIdStringUtils.parsePortletEntityId(portletWindowIdString);
        // then
        assertEquals(portletWindowIdString, result);
    }

    @Test
    public void parsePortletEntityIdMethodShouldReturnCorrectResultWhenPortletWindowIdHasWindowInstanceId() {
        // given
    ...
    @Test
    public void parsePortletEntityIdMethodShouldReturnResultEqualToInputWhenPortletWindowIdHasNoWindowInstanceIdAndHasDelegateWithWindowInstanceId() {
        // given
    ...
    @Test
    public void parsePortletEntityIdMethodShouldReturnCorrectResultWhenPortletWindowIdHasWindowInstanceIdAndHasDelegateWithWindowInstanceId() {
        // given
    ...
    @Test
    public void parsePortletWindowInstanceIdMethodShouldReturnNullWhenWhenPortletWindowIdHasNoWindowInstanceId() {
        // given
        final String portletWindowIdString = "90_n155_18";
        // when
        final String result = PortletWindowIdStringUtils.parsePortletWindowInstanceId(portletWindowIdString);
        // then
        assertNull(result);
    }

    @Test
    public void parsePortletWindowInstanceIdMethodShouldReturnCorrectResultWhenPortletWindowIdHasWindowInstanceId() {
        // given
        final String portletEntityIdString = "90_n155_18";
    ...
    @Test
    public void parsePortletWindowInstanceIdMethodShouldReturnNullWhenPortletWindowIdHasNoWindowInstanceIdAndHasDelegateWithWindowInstanceId() {
        // given
        final String portletWindowIdString = "90_dlg-5-ctf1-18.tw_18";
        // when
        final String result = PortletWindowIdStringUtils.parsePortletWindowInstanceId(portletWindowIdString);
    ...
    @Test
    public void parsePortletWindowInstanceIdMethodShouldReturnCorrectResultWhenPortletWindowIdHasWindowInstanceIdAndHasDelegateWithWindowInstanceId() {
        // given
