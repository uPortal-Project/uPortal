...
public class LimitingTeeWriter extends TeeWriter {
    ...
    /**
     * Sets the character count back to 0. If {@link #isLimitReached()} is true it is set back to
     * false and the original branch {@link Writer} is set as the current branch again.
     */
