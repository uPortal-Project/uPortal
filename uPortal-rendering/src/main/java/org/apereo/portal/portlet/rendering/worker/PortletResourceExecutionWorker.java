...
import org.apereo.portal.portlet.rendering.ResourcePortletOutputHandler;

class PortletResourceExecutionWorker extends PortletExecutionWorker<Long>
        implements IPortletResourceExecutionWorker {
    ...
    /* (non-Javadoc)
     * @see org.apereo.portal.portlet.rendering.PortletExecutionManager.PortletExecutionWorker#callInternal()
     */
    @Override
