...
public interface PortletExecutionManagerMXBean {
    ...
    /**
     * @param maxEventIterations The maximum number of iterations to spend dispatching events for a
     *     single event request.
     */
    void setMaxEventIterations(int maxEventIterations);

    /**
     * @return The maximum number of iterations to spend dispatching events for a single event
     *     request.
     */
    ...
    /**
     * @param extendedTimeoutExecutions Number of executions from sever start to extend timeouts for
     *     each portlet
     */
