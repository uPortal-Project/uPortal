...
public class CachedPortletData<T extends Serializable>
    ...
    public CachedPortletData(
            T portletResult,
            String cachedWriterOutput,
            byte[] cachedStreamOutput,
            String contentType,
            boolean publicScope,
            String etag,
            int expirationTime) {
        ...
        if (cachedWriterOutput != null && cachedStreamOutput != null) {
            throw new IllegalArgumentException(
                    "Both cachedWriterOutput and cachedStreamOutput have been specified");
        }
    ...
    public void updateExpirationTime(int expirationTime) {
        if (expirationTime == -1) {
            ...
            this.expirationTime =
                    System.currentTimeMillis() + TimeUnit.SECONDS.toMillis(expirationTime);
        }
    }
