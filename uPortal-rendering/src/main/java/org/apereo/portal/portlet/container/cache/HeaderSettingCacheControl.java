...
public class HeaderSettingCacheControl implements CacheControl {
    ...
    public HeaderSettingCacheControl(
            CacheControl cacheControl, PortletResourceOutputHandler portletResourceOutputHandler) {
    ...
    private void setCacheHeaders(int time, boolean publicScope) {
        PortletCachingHeaderUtils.setCachingHeaders(
                time, publicScope, lastModified, this.portletResourceOutputHandler);
    }
