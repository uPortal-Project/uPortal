...
public interface PortletResourceOutputHandler extends PortletOutputHandler {
     ...
     * @return The character encoding that has been set or if nothing has been set the default
     ...
     * @return The locale that has been set or if nothing has been set the default locale for the
     *     response
     */
    Locale getLocale();
}
