...
public interface IFragmentDefinitionDao {
    ...
    /**
     * Obtains the complete set of {@link FragmentDefinition} objects contained within this data
     * source.
     *
    ...
    /**
     * Obtains the {@link FragmentDefinition} object belonging to the specified owner.
     *
