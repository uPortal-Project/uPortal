...
public class FragmentNodeInfo {
     ...
     * dlm:editAllowed attribute for nodes in fragments. If not included then edits to node
     * attributes are allowed. If included with a value other than true then edits are prevented.
     *
     * @param name
     * @return
     */
