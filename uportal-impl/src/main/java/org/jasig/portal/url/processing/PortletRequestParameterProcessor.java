...
public class PortletRequestParameterProcessor implements IRequestParameterProcessor {
    ...
    public boolean processParameters(IWritableHttpServletRequest request, HttpServletResponse response) {
        ...
        this.handlePortletRequestInfo(request, portletRequestInfo);
        
        return true;
    }
    private void handlePortletRequestInfo(IWritableHttpServletRequest request,
...
//        final Map<String, List<String>> publicPortletParameters = portletRequestInfo.getPublicPortletParameters();
        ...
        if (delegatePortletRequestInfo != null) {
            ...
            this.handlePortletRequestInfo(request, delegatePortletRequestInfo);
        }
    }
}
