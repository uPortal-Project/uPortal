 ...
 * 
 * @author jennifer.bourey@gmail.com
 */
public class ManageableChannelsListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			Document registry = ChannelRegistryManager.getManageableChannelRegistry(userInstance.getPerson());
