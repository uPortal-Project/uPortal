    ...
    <form name="parameters" method="post" action="{$baseActionURL}">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="10" class="uportal-background-light">
        <tr class="uportal-channel-text">
          <td>
            <strong>チャネル設定：</strong> 選択したチャネルには修正できる設定があります．</td>
        </tr>
        <tr>
          <td>
                    ...
                    <xsl:otherwise>
                      ...
                      <tr class="uportal-channel-table-header" valign="bottom">
                        <td align="center" nowrap="nowrap">
                          <img alt="インターフェイス画像" src="{$mediaPath}/transparent.gif" width="16" height="8"/>Help<img alt="インターフェイス画像" src="{$mediaPath}/transparent.gif" width="16" height="8"/></td>


                        <td width="100%">チャネル設定</td>
                      </tr>
                      <tr class="uportal-channel-table-header">
        ...
        <tr>
          <td>
            <input type="submit" name="uPTCUP_submit" value="戻る" onclick="document.parameters.uPTCUP_action.value='back'" class="uportal-button"/>
            <input type="submit" name="uPTCUP_submit" value="終了" onclick="document.parameters.uPTCUP_action.value='finished'" class="uportal-button"/>
            <input type="submit" name="uPTCUP_submit" value="キャンセル" onclick="document.parameters.uPTCUP_action.value='cancel'" class="uportal-button"/>
          </td>
        </tr>
      </table>
    </form>
