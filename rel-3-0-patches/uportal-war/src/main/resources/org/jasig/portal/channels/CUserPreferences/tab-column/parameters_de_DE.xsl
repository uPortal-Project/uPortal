...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <form name="parameters" method="post" action="{$baseActionURL}">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="10" class="uportal-background-light">
        <tr class="uportal-channel-text">
          <td>
            <strong>Channeleinstellungen:</strong> Der Channel den Sie ausgewählt haben hat Einstellungen die geändert werden müssen.</td>
        </tr>
        <tr>
          <td>
                  ...
                  <xsl:choose>
                    <xsl:when test="not(/userPrefParams/channelDef)">
                      <tr class="uportal-channel-table-header" valign="bottom">
                        <td width="100%">Allgemeine Channeleinstellungen</td>
                      </tr>
                      <tr class="uportal-channel-table-header">
                        <td align="center">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="uportal-background-light">
                            <tr>
                              <td>
                                <img alt="Schnittstellenbild" src="{$mediaPath}/transparent.gif" width="2" height="2"/>
                              </td>
                            </tr>
                          </table>
                        </td>
                    ...
                    <xsl:otherwise>
                      ...
                      <tr class="uportal-channel-table-header" valign="bottom">
                        <td align="center" nowrap="nowrap">
                          <img alt="Schnittstellenbild" src="{$mediaPath}/transparent.gif" width="16" height="8"/>Help<img alt="Schnittstellenbild" src="{$mediaPath}/transparent.gif" width="16" height="8"/></td>


                        <td width="100%">Channeleinstellungen</td>
                      </tr>
                      <tr class="uportal-channel-table-header">
        ...
        <tr>
          <td>
            <input type="submit" name="uPTCUP_submit" value=\"Zurück\" onclick="document.parameters.uPTCUP_action.value='back'" class="uportal-button"/>
            <input type="submit" name="uPTCUP_submit" value=\"Zu Ende\" onclick="document.parameters.uPTCUP_action.value='finished'" class="uportal-button"/>
            <input type="submit" name="uPTCUP_submit" value=\"Abbrechen\" onclick="document.parameters.uPTCUP_action.value='cancel'" class="uportal-button"/>
          </td>
        </tr>
      </table>
    </form>
  ...
  <xsl:template match="example">
    <img alt="Schnittstellenbild" src="{$mediaPath}/transparent.gif" width="8" height="8"/>
