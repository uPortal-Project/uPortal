  ...
  <xsl:template match="profile">
        <form name="form1" method="post" action="{$baseActionURL}">
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td colspan="4" class="uportal-channel-table-header" valign="top">Modifica il Profilo</td>
            </tr>
            ...
            <tr>
              <td colspan="4" class="uportal-label" valign="top">Nome del Profilo:</td>
            </tr>
            ...
            <tr>
              <td colspan="4" class="uportal-label" valign="top">Descrizione del Profilo:</td>
            </tr>
    ...
    <tr>
      <td colspan="4" valign="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr valign="top">
            <td align="center" class="uportal-channel-subtitle">Seleziona</td>

            <td align="center" class="uportal-channel-subtitle">Tipo di dispositivo</td>

            <td width="100%" class="uportal-channel-subtitle">
              <div align="center">Nome/Descrizione</div>
            </td>

            <td class="uportal-channel-subtitle" align="center">
              <div align="center">Campione</div>
            </td>
          </tr>
    ...
    <tr valign="top">
      ...
      <xsl:choose>
        <xsl:when test="sampleiconuri =''">
          <td align="center" valign="middle" class="uportal-text-small">Nessun Campione
          <br />
