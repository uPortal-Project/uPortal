...
public @interface DialectAwareTransactional {
    ...
    /**
     * If true then a {@link Dialect} match against {@link #value()} results in no TX. If false then
     * the lack of a {@link Dialect} match against {@link #value()} results in no TX.
     */
