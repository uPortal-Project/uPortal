...
/**
 * Defines an api for a caching service that caches and retrieves <code>IBasicEntities</code>.
 * Cached entities of a given type are stored in an <code>IEntityCache</code>. The service manages
 * access to these caches and is respon sible for initiating any cache clean up or invalidation.
 *
 * <p>The actual caching api is minimal:
 *
 * <p><code>
