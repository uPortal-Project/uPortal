...
public enum Headers {
  ...
  /**
   * HTTP header sent by the {@link SoffitConnectorController} containing the {@link PortalRequest}
   * for the Soffit in the form of an encrypted JWT.
   *
   * @since 5.0
   */
  ...
  /**
   * HTTP header sent by the {@link SoffitConnectorController} containing preferences for the Soffit
   * in the form of an encrypted JWT.
   *
   * @since 5.0
   */
  ...
  /**
   * The default value for the <code>Cache-Control</code> header is "no-store," which indicates the
   * response should never be cached. Currently, this header value will be sent if the Soffit does
   * not specify a value for <strong>both</strong> scope or max-age.
   */
