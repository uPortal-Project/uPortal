...
public class AbstractJwtService {
  ...
  public void init() {
    ...
    if (StringUtils.isBlank(signatureKey)) {
      ...
      logger.warn(
          "Property {} is using the deafult value;  please change it", SIGNATURE_KEY_PROPERTY);
    }
  ...
  protected String generateEncryptedToken(Claims claims) {
    ...
    final String jwt =
        Jwts.builder().setClaims(claims).signWith(SignatureAlgorithm.HS512, signatureKey).compact();
