...
public enum JwtClaims {
  ...
  /**
   * Used both by by Definition objects (publication parameters of the content object configured in
   * the Portlet Manager) and by PortalRequest objects (request parameters).
   */
