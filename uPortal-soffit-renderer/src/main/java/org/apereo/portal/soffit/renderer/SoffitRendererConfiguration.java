...
/**
 * Provided for Java-based Spring configuration of Soffit Render technology. Add this single class
 * to your application context, rather than several individual beans.
 *
 * @since 5.0
 */
@Configuration
