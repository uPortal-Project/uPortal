 ...
 *
 * <p>An unauthenticatable security context which a security context factory may return in the case
 * where its initialization of the security context it was supposed to return failed. This allows a
 * security context factory to "fail gracefully", fulfilling its API contract and allowing other
 * security contexts in the chain to continue to operate.
 *
 * <p>
 *
