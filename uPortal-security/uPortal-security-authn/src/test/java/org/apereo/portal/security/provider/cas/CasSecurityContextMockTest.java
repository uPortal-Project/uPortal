...
/**
 * A JUnit test that exercises the CasSecurityContextMock mock object. The mock object is useless if
 * it cannot be relied upon to correctly emulate an ICasSecurityContext instance as configured. This
 * test is intended to increase confidence that the mock object behaves as advertised.
 */
public class CasSecurityContextMockTest extends TestCase {
