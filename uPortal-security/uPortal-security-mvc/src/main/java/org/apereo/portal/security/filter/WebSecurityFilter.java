...
public class WebSecurityFilter implements Filter {
    ...
    public static final String PARAM_CONTENT_SECURITY_POLICY_ENABLED = "sec.content.sec.policy.enabled";
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
        ...
        if (hstsEnabled) {
            ...
            response.setHeader(WebSecurityFilter.DEFAULT_HSTS_HEADER_NAME, StringUtils.chop(declarations));
        }
        ...
        if (antiJackClickingEnabled) {
            ...
            } else if (antiJackClickingOptions.equals("allow-from") && !antiJackClickingUri.isEmpty()) {
    ...
    public void init() throws ServletException {
        parseAndStore (
            ...
            getInitParameter(PARAM_ANTI_JACK_CLICKING_ENABLED, DEFAULT_ANTI_JACK_CLICKING_ENABLED),
            getInitParameter(PARAM_ANTI_JACK_CLICKING_OPTIONS, DEFAULT_ANTI_JACK_CLICKING_OPTIONS),
            ...
            getInitParameter(PARAM_CONTENT_SECURITY_POLICY_ENABLED, DEFAULT_CONTENT_SECURITY_POLICY_ENABLED),
