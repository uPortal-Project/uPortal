...
public interface IDatabaseMetadata {
  ...
  /**
   * Returns <code>true</code> if the database server supports outer joins. The query to use if this
   * returns <code>true</code> can be retrieved from the {@link #getJoinQuery()} method.
   *
