...
public final class HibernateConfigurationAwareInjector {
    ...
    @Autowired
    public void setHibernateConfigurationAwareBeans(
            Collection<HibernateConfigurationAware> hibernateConfigurationAwareBeans) {
    ...
    public void setConfiguration(
        ...
        for (final HibernateConfigurationAware hibernateConfigurationAware :
                hibernateConfigurationAwareBeans) {
            if (hibernateConfigurationAware.supports(persistenceUnit)) {
                hibernateConfigurationAware.setConfiguration(
                        persistenceUnit, hibernateConfiguration);
            }
        }
    }
}
