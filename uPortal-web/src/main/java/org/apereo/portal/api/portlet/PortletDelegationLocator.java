...
public interface PortletDelegationLocator {
    ...
    public PortletDelegationDispatcher createRequestDispatcher(
            PortletRequest request, String fName);

    /**
     * Creates a new portlet delegation dispatcher and corresponding portlet window
     *
     * @param request The current request
     * @param portletDefinitionId The portlet definition id of the portlet to create a dispatcher
     *     for
     * @return The dispatcher
     */
    public PortletDelegationDispatcher createRequestDispatcher(
            PortletRequest request, IPortletDefinitionId portletDefinitionId);
    ...
    public PortletDelegationDispatcher getRequestDispatcher(
            PortletRequest request, IPortletWindowId portletWindowId);
}
