...
public class MarketplaceService implements IMarketplaceService, ApplicationListener<LoginEvent> {
        ...
        if (element == null) {
            final MarketplacePortletDefinition mpd =
                    new MarketplacePortletDefinition(
                            portletDefinition, this, portletCategoryRegistry);
     ...
     */
    private static boolean mayBrowse(
            final IAuthorizationPrincipal principal, final String targetId) {
    ...
    public void setPortletDefinitionRegistry(
        ...
        Validate.notNull(
                portletDefinitionRegistry, "Portlet definition registry must not be null.");
