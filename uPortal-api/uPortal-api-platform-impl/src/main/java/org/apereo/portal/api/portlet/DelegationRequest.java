...
public class DelegationRequest {
    ...
    public int hashCode() {
        ...
        result =
                prime * result
                        + ((this.parentParameters == null) ? 0 : this.parentParameters.hashCode());
        result =
                prime * result
                        + ((this.parentPortletMode == null)
                                ? 0
                                : this.parentPortletMode.hashCode());
        result =
                prime * result
                        + ((this.parentWindowState == null)
                                ? 0
                                : this.parentWindowState.hashCode());
        return result;
    }
    /* (non-Javadoc)
    ...
    public boolean equals(Object obj) {
        ...
        if (this.parentParameters == null) {
            if (other.parentParameters != null) return false;
        } else if (!this.parentParameters.equals(other.parentParameters)) return false;
        if (this.parentPortletMode == null) {
            if (other.parentPortletMode != null) return false;
        } else if (!this.parentPortletMode.equals(other.parentPortletMode)) return false;
        if (this.parentWindowState == null) {
            if (other.parentWindowState != null) return false;
        } else if (!this.parentWindowState.equals(other.parentWindowState)) return false;
        return true;
    }
    /* (non-Javadoc)
    ...
    public String toString() {
        return "DelegationRequest [delegateState="
                + this.delegateState
                + ", parentWindowState="
                + this.parentWindowState
                + ", parentPortletMode="
                + this.parentPortletMode
                + ", parentParameters="
