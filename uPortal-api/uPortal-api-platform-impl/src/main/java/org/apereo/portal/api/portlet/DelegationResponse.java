...
public class DelegationResponse {
    ...
    public int hashCode() {
        ...
        int result = 1;
        result =
                prime * result + ((this.delegateState == null) ? 0 : this.delegateState.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.delegateState == null) {
            if (other.delegateState != null) return false;
        } else if (!this.delegateState.equals(other.delegateState)) return false;
        return true;
    }
