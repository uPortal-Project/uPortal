...
/**
 * Notification interface. Implementations should notify users that their local uportal user account
 * has had a password reset token assigned to it and pass along the URL that can be used to reset
 * their password.
 */
